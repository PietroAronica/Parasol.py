...
do
 mkdir Run_$i
 cd Run_$i
 nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Production_X0.5_50_2.in -o Production_0_100.out -c ../Store/Solv_0_100.inpcrd -p ../Store/Solv_0_100.prmtop -r 0_100.restart -x 0_100.mdcrd
 fail=0
