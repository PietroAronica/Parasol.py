...
do
 mkdir Run_$i
 cd Run_$i
 nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Min.in -o First_minimisation.out -c ../Store/Solv_0_100.inpcrd -p ../Store/Solv_0_100.prmtop -r 0_100_min1.restart -ref ../Store/Solv_0_100.inpcrd
 fail=0
 ...
 nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Heat.in -o First_heat.out -c 0_100_min1.restart -p ../Store/Solv_0_100.prmtop -r 0_100_ht1.restart -x 0_100_ht1.mdcrd -ref 0_100_min1.restart
 fail=0
 until grep -q "Total wall time" First_heat.out
 do
  nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Heat.in -o First_heat.out -c 0_100_min1.restart -p ../Store/Solv_0_100.prmtop -r 0_100_ht1.restart -x 0_100_ht1.mdcrd -ref 0_100_min1.restart
  fail=$(($fail+1))
  if [ $fail -eq 10 ]
 ...
 nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Heat2.in -o Second_heat.out -c 0_100_ht1.restart -p ../Store/Solv_0_100.prmtop -r 0_100_ht2.restart -x 0_100_ht2.mdcrd -ref 0_100_ht1.restart
 fail=0
 until grep -q "Total wall time" Second_heat.out
 do
  nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Heat2.in -o Second_heat.out -c 0_100_ht1.restart -p ../Store/Solv_0_100.prmtop -r 0_100_ht2.restart -x 0_100_ht2.mdcrd -ref 0_100_ht1.restart
  fail=$(($fail+1))
  if [ $fail -eq 10 ]
 ...
 nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Hold.in -o First_hold.out -c 0_100_ht2.restart -p ../Store/Solv_0_100.prmtop -r 0_100_ho.restart -x 0_100_ho.mdcrd
 fail=0
 until grep -q "Total wall time" First_hold.out
 do
  nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Hold.in -o First_hold.out -c 0_100_ht2.restart -p ../Store/Solv_0_100.prmtop -r 0_100_ho.restart -x 0_100_ho.mdcrd
  fail=$(($fail+1))
  if [ $fail -eq 10 ]
 ...
 nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Prod.in -o Production_0_100.out -c 0_100_ho.restart -p ../Store/Solv_0_100.prmtop -r 0_100.restart -x 0_100.mdcrd
 fail=0
 ...
 do
  nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Prod.in -o Production_0_100.out -c 0_100_eq2.restart -p ../Store/Solv_0_100.prmtop -r 0_100.restart -x 0_100.mdcrd
  nohup pmemd.cuda_SPFP -O -i ~/Python/SimFiles/Mutation/Lipid_Prod.in -o Production_10_90.out -c 0_100.restart -p ../Store/Solv_10_90.prmtop -r 10_90.restart -x 10_90.mdcrd
  fail=$(($fail+1))
  if [ $fail -eq 10 ]
  then
