...
def lib_make(ff, outputfile, vxi='VXI', thisul='sc', thihyd='ch', hydhyd1='yh', alcoxy='oh', alchyd='hh', hydhyd2='sh', thrhyd='hf', cyshyd='gh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
...
def stock_add_to_all(vxi='VXI', thisul='sc', thihyd='ch', hydhyd1='yh', alcoxy='oh', alchyd='hh', hydhyd2='sh', thrhyd='hf', cyshyd='gh'):
	...
	for i in range(11):
		...
		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), cyshyd, lac(p['H1'][0], p['HC'][0], i), lac(p['H1'][1], p['HC'][1], i))
                ...
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CT', hydhyd1), lac(p['HC_sS'][0], p['CT_HC'][0], i), lac(p['HC_sS'][1], p['CT_HC'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd1, 'CT', thisul), lac(p['Close'][0], p['Close'][0], i), lac(p['Close'][1], p['Close'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', hydhyd1), lac(p['C_C_SH'][0], p['C_C_H'][0], i), lac(p['C_C_SH'][1], p['C_C_H'][1], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd1, 'CT', thisul, thihyd), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
