...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                changeLJPair(parm, ':{}@HG22'.format(vxi), ':{}@HD11'.format(vxi), '0', '0').execute()
                changeLJPair(parm, ':{}@HG22'.format(vxi), ':{}@HD21'.format(vxi), '0', '0').execute()
                changeLJPair(parm, ':{}@HG23'.format(vxi), ':{}@HD11'.format(vxi), '0', '0').execute()
                changeLJPair(parm, ':{}@HG23'.format(vxi), ':{}@HD21'.format(vxi), '0', '0').execute()
