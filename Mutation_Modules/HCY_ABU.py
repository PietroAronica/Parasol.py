	...
	pdb = open(out, 'w')
        ...
        for res in struct.residue_list:
			...
			if atom.get_name() == 'CG' and res.get_resname() == vxi:
                        	...
                        	pdb.write(atom.superimposed1('HG1', SD))
			else:
                        	pdb.write(atom.formatted())
                try:
...
def stock_add_to_all(thisul='hs', thihyd='hh', hydhyd='sh', cyshyd='fh'):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', hydhyd), cal(p['C_C_SH'][0], p['C_C_H'][0], i), cal(p['C_C_SH'][1], p['C_C_H'][1], i))
