...
def lib_make(ff, outputfile, vxi='VXI', quacar='dc', quahyd='dh', carhyd='mh', nithyd='nh', alcoxy='ho', alchyd='hh', hydhyd='sh', serhyd='fh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
...
def stock_add_to_all(quacar='dc', quahyd='dh', carhyd='mh', nithyd='nh', alcoxy='ho', alchyd='hh', hydhyd='sh', serhyd='fh'):
