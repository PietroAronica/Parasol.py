...
def lib_make(ff, outputfile, vxi='VXI', carcar='cc', caroxy='co', hydhyd1='sh', amicar='ac', amioxy='ao', aminit='an', amihyd='ah', hydhyd2='rh'):
        ctrl = open('lyp.in', 'w')
...
def stock_add_to_all(hydhyd2='rh', carcar='cc', caroxy='co', hydhyd1='sh', amicar='ac', amioxy='ao', aminit='an', amihyd='ah'):
