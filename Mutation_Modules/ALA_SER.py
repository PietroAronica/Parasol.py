	...
	pdb = open(out, 'w')
        ...
        for res in struct.residue_list:
			...
			if atom.get_name() == 'HB3' and res.get_resname() == vxi:
                        	...
                        	pdb.write(atom.halfway_between('OG', CB, HB1))
...
def lib_make(ff, outputfile, vxi='VXI', alcoxy='oh', alchyd='hh', hydhyd='hs', serhyd='hf'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
...
def stock_add_to_all(alcoxy='oh', alchyd='hh', hydhyd='hs', serhyd='hf'):
