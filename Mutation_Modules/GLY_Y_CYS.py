...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@CA'.format(vxi), ':{}@H2'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HA'.format(vxi), ':{}@H2'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@O'.format(vxi), ':{}@H'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@O'.format(vxi), ':{}@H1'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@O'.format(vxi), ':{}@HA13'.format(vxi), '0', '0').execute()
...
def lib_make(ff, outputfile, vxi='VXI', var=variablemake()):
	...
	newoxy = var[8]
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/GLY_X_CYS.pdb\n"%vxi)
	...
	ctrl.write('set %s.1.15 type "SH"\n'%vxi)
	ctrl.write('set %s.1.16 type "HS"\n'%vxi)
...
def stock_add_to_all(var=variablemake()):
	...
	newoxy = var[8]
        ...
        for i in range(11):
                ...
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(oldnit, 'CT'), lac(p['Third'][0], p['CT_N2'][0], i), lac(p['Third'][1], p['CT_N2'][1], i))
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(newcar, oldnit, 'CT'), lac(p['Dritt'][0], p['C_N_CT'][0], i), lac(p['Dritt'][1], p['C_N_CT'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(oldhyd, oldnit, 'CT'), lac(p['Close'][0], p['CT_N_H'][0], i), lac(p['Close'][1], p['CT_N_H'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(oldnit, 'CT', 'H1'), lac(p['C_C_H'][0], p['C_C_H'][0], i), lac(p['C_C_H'][1], p['C_C_H'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(oldnit, 'CT', 'CT'), lac(p['CT_CT_N'][0], p['CT_CT_N'][0], i), lac(p['CT_CT_N'][1], p['CT_CT_N'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(oldnit, 'CT', 'C '), lac(p['N_CT_C'][0], p['N_CT_C'][0], i), lac(p['N_CT_C'][1], p['N_CT_C'][1], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newalp, newcar, oldnit, 'CT'), lac(p['Ring_0'][0], p['X_C_N_X'][0], i), lac(p['Ring_0'][1], p['X_C_N_X'][1], i), lac(p['Ring_0'][2], p['X_C_N_X'][2], i), lac(p['Ring_0'][3], p['X_C_N_X'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newoxy, newcar, oldnit, 'CT'), lac(p['Ring_0'][0], p['X_C_N_X'][0], i), lac(p['Ring_0'][1], p['X_C_N_X'][1], i), lac(p['Ring_0'][2], p['X_C_N_X'][2], i), lac(p['Ring_0'][3], p['X_C_N_X'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newcar, oldnit, 'CT', 'H1'), lac(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), lac(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), lac(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), lac(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newcar, oldnit, 'CT', 'C '), lac(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), lac(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), lac(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), lac(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(oldhyd, oldnit, 'CT', 'H1'), lac(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), lac(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), lac(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), lac(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(oldhyd, oldnit, 'CT', 'CT'), lac(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), lac(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), lac(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), lac(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(oldhyd, oldnit, 'CT', 'C '), lac(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), lac(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), lac(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), lac(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
