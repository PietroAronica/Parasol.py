...
def stock_add_to_all(metcar='cd', methyd='dh', hydhyd1='mh', thisul='sc', thihyd='ch', hydhyd2='sh', cyshyd='hf'):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cyshyd, 'CT', metcar), cal(p['C_C_H'][0], p['C_C_H'][0], i), cal(p['C_C_H'][1], p['C_C_H'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(thihyd, thisul, 'CT', hydhyd1), cal(p['0_5'][0], p['X_C_SH_X'][0], i), cal(p['0_5'][1], p['X_C_SH_X'][1], i), cal(p['0_5'][2], p['X_C_SH_X'][2], i), cal(p['0_5'][3], p['X_C_SH_X'][3], i))
		...
		Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), thisul, lac(p['OH'][2], p['0_O'][2], i), lac(p['OH'][3], p['0_O'][3], i))
		Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), thihyd, lac(p['HO'][2], p['0_H'][2], i), lac(p['HO'][3], p['0_H'][3], i))
