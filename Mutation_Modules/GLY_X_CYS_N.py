...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@CA'.format(vxi), ':{}@H'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@O'.format(vxi), ':{}@HAX2'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@O'.format(vxi), ':{}@HAX3'.format(vxi), '0', '0').execute()
