...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@HD11'.format(vxi), ':{}@HD21'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HG2'.format(vxi), ':{}@HD2'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HG3'.format(vxi), ':{}@HD3'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HD1'.format(vxi), ':{}@HE1'.format(vxi), '0', '0').execute()
                ...
                change(parm, 'charge', ':{}@HD1'.format(vxi), bc['HE']-(bc['HE']/10)*i).execute()
	...
	pdb = open(out, 'w')
		...
		for atom in res.atom_list:
			if atom.get_name() == 'CG' and res.get_resname() == vxi:
				...
				pdb.write(atom.halfway_between('CE', CE, HE)) 
				pdb.write(atom.superimposed1('HE1', HE)) 
				pdb.write(atom.superimposed2('HE1', HE)) 
				pdb.write(atom.superimposed3('HE3', HE)) 
			else:
				pdb.write(atom.formatted())
	                try:
...
#               Frcmod_creator.IMPROPER_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('X', 'X', cd, 'HA'), cal(p['Ring_imp'][0], p['Ring_imp'][0], i), cal(p['Ring_imp'][1], p['Ring_imp'][1], i), cal(p['Ring_imp'][2], p['Ring_imp'][2], i))
		...
		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), hydhyd, lac(p['0_H'][0], p['HA'][0], i), lac(p['0_H'][1], p['HA'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(cd, metcar), lac(p['CT_CT'][0], p['CT_mH'][0], i), lac(p['CT_CT'][1], p['CT_mH'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(cd, hydhyd), lac(p['HC_sC'][0], p['CA_HA'][0], i), lac(p['HC_sC'][1], p['CA_HA'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd, cd, hd2), lac(p['C_C_H'][0], p['A_CA_CA_HA'][0], i), lac(p['C_C_H'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd, cd, hd3), lac(p['C_C_H'][0], p['A_CA_CA_HA'][0], i), lac(p['C_C_H'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd, cd, cd1), lac(p['C_C_H'][0], p['A_CA_CA_HA'][0], i), lac(p['C_C_H'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd, cd, cd2), lac(p['C_C_H'][0], p['A_CA_CA_HA'][0], i), lac(p['C_C_H'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(metcar, cd, hd2), lac(p['C_C_H'][0], p['A_CA_CA_HA'][0], i), lac(p['C_C_H'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(metcar, cd, hd3), lac(p['C_C_H'][0], p['A_CA_CA_HA'][0], i), lac(p['C_C_H'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(metcar, cd, cd1), lac(p['C_C_H'][0], p['A_CA_CA_HA'][0], i), lac(p['C_C_H'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(metcar, cd, cd2), lac(p['C_C_H'][0], p['A_CA_CA_HA'][0], i), lac(p['C_C_H'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cd, metcar, methyd), lac(p['C_C_H'][0], p['Dritt'][0], i), lac(p['C_C_H'][1], p['Dritt'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd, cd, metcar), lac(p['Close'][0], p['Close'][0], i), lac(p['Close'][1], p['Close'][1], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hd2, cd, metcar, methyd), lac(p['H_C_C_H'][0], p['0_1'][0], i), lac(p['H_C_C_H'][1], p['0_1'][1], i), lac(p['H_C_C_H'][2], p['0_1'][2], i), lac(p['H_C_C_H'][3], p['0_1'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hd3, cd, metcar, methyd), lac(p['H_C_C_H'][0], p['0_1'][0], i), lac(p['H_C_C_H'][1], p['0_1'][1], i), lac(p['H_C_C_H'][2], p['0_1'][2], i), lac(p['H_C_C_H'][3], p['0_1'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd, cd, metcar, methyd), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cd1, cd, metcar, methyd), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cd2, cd, metcar, methyd), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hd11, cd1, cd, metcar), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hd21, cd2, cd, metcar), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd1, cd, metcar), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd2, cd, metcar), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd, cd, cd1, hd11), lac(p['Ring_0'][0], p['Ring_Dihe'][0], i), lac(p['Ring_0'][1], p['Ring_Dihe'][1], i), lac(p['Ring_0'][2], p['Ring_Dihe'][2], i), lac(p['Ring_0'][3], p['Ring_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd, cd, cd2, hd21), lac(p['Ring_0'][0], p['Ring_Dihe'][0], i), lac(p['Ring_0'][1], p['Ring_Dihe'][1], i), lac(p['Ring_0'][2], p['Ring_Dihe'][2], i), lac(p['Ring_0'][3], p['Ring_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd, cd, cd1, cg), lac(p['Ring_0'][0], p['Ring_Dihe'][0], i), lac(p['Ring_0'][1], p['Ring_Dihe'][1], i), lac(p['Ring_0'][2], p['Ring_Dihe'][2], i), lac(p['Ring_0'][3], p['Ring_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd, cd, cd2, cg), lac(p['Ring_0'][0], p['Ring_Dihe'][0], i), lac(p['Ring_0'][1], p['Ring_Dihe'][1], i), lac(p['Ring_0'][2], p['Ring_Dihe'][2], i), lac(p['Ring_0'][3], p['Ring_Dihe'][3], i))
		...
		Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), hydhyd, lac(p['0_H'][2], p['HA'][2], i), lac(p['0_H'][3], p['HA'][3], i))
