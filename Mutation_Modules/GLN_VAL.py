...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@HG11'.format(vxi), ':{}@OE1'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HG11'.format(vxi), ':{}@NE2'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HG11'.format(vxi), ':{}@HE21'.format(vxi), '0', '0').execute()
