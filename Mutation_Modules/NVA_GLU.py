...
def lib_make(ff, outputfile, vxi='VXI', metcar='1c', methyd='1h', hydhyd1='xh', carcar='cc', caroxy='co', hydhyd2='sh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source leaprc.%s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/GLU-NVA.pdb\n"%vxi)
...
def stock_add_to_all(vxi='VXI', metcar='1c', methyd='1h', hydhyd1='xh', carcar='cc', caroxy='co', hydhyd2='sh'):
