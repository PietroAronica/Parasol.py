...
def stock_add_to_all(cd='1c', ce='2c', he='2h', oh='ho', hh='hh'):
	...
	for i in range(11):
		...
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CA', oh), cal(p['CA_OH'][0], p['OH_mHA'][0], i), cal(p['CA_OH'][1], p['OH_mHA'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(ce, 'CA', oh), cal(p['F_CT_CA_CA'][0], p['A_CT_CA_CA'][0], i), cal(p['F_CT_CA_CA'][1], p['A_CT_CA_CA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CA', oh, hh), cal(p['CA_O_H'][0], p['Dritt'][0], i), cal(p['CA_O_H'][1], p['Dritt'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(he, ce, 'CA', oh), cal(p['Ring_Dihe'][0], p['Ring_0'][0], i), cal(p['Ring_Dihe'][1], p['Ring_0'][1], i), cal(p['Ring_Dihe'][2], p['Ring_0'][2], i), cal(p['Ring_Dihe'][3], p['Ring_0'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cd, ce, 'CA', oh), cal(p['Ring_Dihe'][0], p['Ring_0'][0], i), cal(p['Ring_Dihe'][1], p['Ring_0'][1], i), cal(p['Ring_Dihe'][2], p['Ring_0'][2], i), cal(p['Ring_Dihe'][3], p['Ring_0'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(ce, 'CA', oh, hh), cal(p['Ring_Tyr'][0], p['0_6'][0], i), cal(p['Ring_Tyr'][1], p['0_6'][1], i), cal(p['Ring_Tyr'][2], p['0_6'][2], i), cal(p['Ring_Tyr'][3], p['0_6'][3], i))
		...
		Frcmod_creator.IMPROPER_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(ce, 'CA', ce, oh), cal(p['Ring_imp'][0], p['Imp_0'][0], i), cal(p['Ring_imp'][1], p['Imp_0'][1], i), cal(p['Ring_imp'][2], p['Imp_0'][2], i))
