...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                changeLJPair(parm, ':{}@HH2'.format(vxi), ':{}@CE2'.format(vxi), '0', '0').execute()
                changeLJPair(parm, ':{}@HT'.format(vxi), ':{}@HH1'.format(vxi), '0', '0').execute()
                changeLJPair(parm, ':{}@HT'.format(vxi), ':{}@CZ1'.format(vxi), '0', '0').execute()
