...
def lib_make(ff, outputfile, vxi='VXI', var=variablemake()):
	...
	difhyd = var[2]
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/CYS-HC1.pdb\n"%vxi)
	...
	ctrl.write('set %s.1.11 type "SH"\n'%vxi)
	ctrl.write('set %s.1.12 type "HS"\n'%vxi)
...
def stock_add_to_all(var=variablemake()):
	...
	for i in range(11):
		...
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(intcar, 'SH'), cal(p['CT_mS'][0], p['CT_SH'][0], i), cal(p['CT_mS'][1], p['CT_SH'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(inthyd, intcar, 'SH'), cal(p['Close'][0], p['C_C_H'][0], i), cal(p['Close'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', intcar, 'SH'), cal(p['Dritt'][0], p['C_C_SH'][0], i), cal(p['Dritt'][1], p['C_C_SH'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(intcar, 'SH', 'HS'), cal(p['C_SH_H'][0], p['C_SH_H'][0], i), cal(p['C_SH_H'][1], p['C_SH_H'][1], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', intcar, 'SH', 'HS'), cal(p['0_5'][0], p['X_C_SH_X'][0], i), cal(p['0_5'][1], p['X_C_SH_X'][1], i), cal(p['0_5'][2], p['X_C_SH_X'][2], i), cal(p['0_5'][3], p['X_C_SH_X'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(inthyd, intcar, 'SH', 'HS'), cal(p['0_5'][0], p['X_C_SH_X'][0], i), cal(p['0_5'][1], p['X_C_SH_X'][1], i), cal(p['0_5'][2], p['X_C_SH_X'][2], i), cal(p['0_5'][3], p['X_C_SH_X'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(difhyd, 'CT', intcar, 'SH'), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', intcar, 'SH'), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
