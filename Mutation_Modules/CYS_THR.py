...
def stock_add_to_all(metcar='dc', methyd='dh', hydhyd='mh', thioxy='so', thihyd='sh'):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(metcar, 'CT', thioxy), lac(p['C_C_H'][0], p['C_C_H'][0], i), lac(p['C_C_H'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd, 'CT', thioxy), lac(p['C_C_H'][0], p['C_C_H'][0], i), lac(p['C_C_H'][1], p['C_C_H'][1], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(thioxy, 'CT', metcar, methyd), lac(p['C_C_O_H_2'][0], p['0_3'][0], i), lac(p['C_C_O_H_2'][1], p['0_3'][1], i), lac(p['C_C_O_H_2'][2], p['0_3'][2], i), lac(p['C_C_O_H_2'][3], p['0_3'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(thioxy, 'CT', metcar, methyd), lac(p['C_C_O_H_1'][0], p['0_2'][0], i), lac(p['C_C_O_H_1'][1], p['0_2'][1], i), lac(p['C_C_O_H_1'][2], p['0_2'][2], i), lac(p['C_C_O_H_1'][3], p['0_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(thihyd, thioxy, 'CT', hydhyd), lac(p['0_5'][0], p['X_C_SH_X'][0], i), lac(p['0_5'][1], p['X_C_SH_X'][1], i), lac(p['0_5'][2], p['X_C_SH_X'][2], i), lac(p['0_5'][3], p['X_C_SH_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(thihyd, thioxy, 'CT', metcar), lac(p['C_C_O_H_2'][0], p['0_3'][0], i), lac(p['C_C_O_H_2'][1], p['0_3'][1], i), lac(p['C_C_O_H_2'][2], p['0_3'][2], i), lac(p['C_C_O_H_2'][3], p['0_3'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(thihyd, thioxy, 'CT', metcar), lac(p['C_C_O_H_1'][0], p['0_2'][0], i), lac(p['C_C_O_H_1'][1], p['0_2'][1], i), lac(p['C_C_O_H_1'][2], p['0_2'][2], i), lac(p['C_C_O_H_1'][3], p['0_2'][3], i))
