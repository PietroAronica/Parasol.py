...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                change(parm, 'charge', ':{}@CD'.format(vxi), bc['CD']-(bc['CD']/10)*i).execute()
...
def lib_make(ff, outputfile, vxi='VXI', metcar='2c', methyd='2h', hydhyd1='yh', alcoxy='oh', alchyd='hh', hydhyd2='sh', thrhyd='hf'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
...
def stock_add_to_all(vxi='VXI', metcar='2c', methyd='2h', hydhyd1='yh', alcoxy='oh', alchyd='hh', hydhyd2='sh', thrhyd='hf'):
