...
def lib_make(ff, outputfile, vxi='VXI', metcar='cd', methyd='dh', hydhyd1='mh', thisul='sc', thihyd='ch', hydhyd2='sh', cyshyd='hf'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
...
def stock_add_to_all(metcar='cd', methyd='dh', hydhyd1='mh', thisul='sc', thihyd='ch', hydhyd2='sh', cyshyd='hf'):
