...
def lib_make(ff, outputfile, vxi='VXI', cg='C*', cd1='CW', hd1='H4', ne1='nt', he1='ht', cd2='CB', ce2='CN', ce3='t2', he3='h8', cz1='t1', hz1='h7', cz2='t4', hz2='h0', ch='t3', hh='h9'):
        ctrl = open('lyp.in', 'w')
...
def stock_add_to_all(cg='C*', cd1='CW', hd1='H4', ne1='nt', he1='ht', cd2='CB', ce2='CN', ce3='t2', he3='h8', cz1='t1', hz1='h7', cz2='t4', hz2='h0', ch='t3', hh='h9'):
...
#		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), cd2, cal(p['CA'][0], p['CA'][0], i), cal(p['CA'][1], p['CA'][1], i))
		...
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(ce3, he3), cal(p['CA_HA'][0], p['HA_tCA'][0], i), cal(p['CA_HA'][1], p['HA_tCA'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(cz1, hz1), cal(p['CA_HA'][0], p['HA_tCA'][0], i), cal(p['CA_HA'][1], p['HA_tCA'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(he1, ne1, ce2), cal(p['CW_NA_H'][0], p['Close'][0], i), cal(p['CW_NA_H'][1], p['Close'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(he1, ne1, cd1), cal(p['F_CA_CA_HA'][0], p['Dritt'][0], i), cal(p['F_CA_CA_HA'][1], p['Dritt'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cd2, ce3, he3), cal(p['F_CA_CA_HA'][0], p['A_Trp'][0], i), cal(p['F_CA_CA_HA'][1], p['A_Trp'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cz2, ce3, he3), cal(p['F_CA_CA_HA'][0], p['Close'][0], i), cal(p['F_CA_CA_HA'][1], p['Close'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(ce2, cz1, hz1), cal(p['F_CA_CA_HA'][0], p['Close'][0], i), cal(p['F_CA_CA_HA'][1], p['Close'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hz1, cz1, ch), cal(p['F_CA_CA_HA'][0], p['A_Trp'][0], i), cal(p['F_CA_CA_HA'][1], p['A_Trp'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hz2, cz2, ch), cal(p['F_CA_CA_HA'][0], p['Dritt'][0], i), cal(p['F_CA_CA_HA'][1], p['Dritt'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd1, ne1, ce2), cal(p['X_CW_NA_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CW_NA_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CW_NA_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CW_NA_X'][3], p['Ring_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hd1, cd1, ne1, ce2), cal(p['X_CW_NA_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CW_NA_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CW_NA_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CW_NA_X'][3], p['Ring_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cz1, ce2, ne1, he1), cal(p['X_CN_NA_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CN_NA_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CN_NA_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CN_NA_X'][3], p['Ring_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cz1, ce2, ne1, cd1), cal(p['X_CN_NA_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CN_NA_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CN_NA_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CN_NA_X'][3], p['Ring_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cd2, ce2, ne1, he1), cal(p['X_CN_NA_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CN_NA_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CN_NA_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CN_NA_X'][3], p['Ring_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cd2, ce2, ne1, cd1), cal(p['X_CN_NA_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CN_NA_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CN_NA_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CN_NA_X'][3], p['Ring_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd2, ce3, he3), cal(p['X_CA_CB_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CA_CB_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CA_CB_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CA_CB_X'][3], p['Ring_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(ce2, cd2, ce3, he3), cal(p['X_CA_CB_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CA_CB_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CA_CB_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CA_CB_X'][3], p['Ring_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd2, ce2, ne1), cal(p['X_CN_CB_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CN_CB_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CN_CB_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CN_CB_X'][3], p['Ring_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(ce3, cd2, ce2, ne1), cal(p['X_CN_CB_X'][0], p['Ring_Dihe'][0], i), cal(p['X_CN_CB_X'][1], p['Ring_Dihe'][1], i), cal(p['X_CN_CB_X'][2], p['Ring_Dihe'][2], i), cal(p['X_CN_CB_X'][3], p['Ring_Dihe'][3], i))
