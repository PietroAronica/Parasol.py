...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@O :{}@H1 0 0'.format(vxi, vxi)).execute()
                ...
                change(parm, 'charge', ':{}@NE1'.format(vxi), bc['NE1']).execute()
                change(parm, 'charge', ':{}@HE1'.format(vxi), bc['HE1']).execute()
                change(parm, 'charge', ':{}@CE2'.format(vxi), bc['CE2']).execute()
                change(parm, 'charge', ':{}@CZ2'.format(vxi), bc['CZ1']).execute()
                change(parm, 'charge', ':{}@HZ2'.format(vxi), bc['HZ1']).execute()
                change(parm, 'charge', ':{}@CH2'.format(vxi), bc['CH']).execute()
                change(parm, 'charge', ':{}@HH2'.format(vxi), bc['HH']).execute()
                change(parm, 'charge', ':{}@CZ3'.format(vxi), bc['CZ2']).execute()
                change(parm, 'charge', ':{}@HZ3'.format(vxi), bc['HZ2']).execute()
                change(parm, 'charge', ':{}@CE3'.format(vxi), bc['CE3']).execute()
...
def lib_make(ff, outputfile, vxi='VXI', var=variablemake()):
	...
	newoxy = var[8]
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/GLY_X_TRP.pdb\n"%vxi)
	...
	ctrl.write('set %s.1.18 name "NE1"\n'%vxi)
	ctrl.write('set %s.1.19 name "HE1"\n'%vxi)
	ctrl.write('set %s.1.20 name "CE2"\n'%vxi)
	ctrl.write('set %s.1.21 name "CZ2"\n'%vxi)
	ctrl.write('set %s.1.22 name "HZ2"\n'%vxi)
	ctrl.write('set %s.1.23 name "CH2"\n'%vxi)
	ctrl.write('set %s.1.24 name "HH2"\n'%vxi)
	ctrl.write('set %s.1.25 name "CZ3"\n'%vxi)
	ctrl.write('set %s.1.26 name "HZ3"\n'%vxi)
	ctrl.write('set %s.1.27 name "CE3"\n'%vxi)
	ctrl.write('set %s.1.28 name "HE3"\n'%vxi)
	ctrl.write('set %s.1.29 name "CD2"\n'%vxi)
	...
	ctrl.write('set %s.1.16 type "CW"\n'%vxi)
	ctrl.write('set %s.1.17 type "H4"\n'%vxi)
	ctrl.write('set %s.1.18 type "NA"\n'%vxi)
	ctrl.write('set %s.1.19 type "H"\n'%vxi)
	ctrl.write('set %s.1.20 type "CN"\n'%vxi)
	ctrl.write('set %s.1.21 type "CA"\n'%vxi)
	ctrl.write('set %s.1.22 type "HA"\n'%vxi)
	ctrl.write('set %s.1.23 type "CA"\n'%vxi)
	ctrl.write('set %s.1.24 type "HA"\n'%vxi)
	ctrl.write('set %s.1.25 type "CA"\n'%vxi)
	ctrl.write('set %s.1.26 type "HA"\n'%vxi)
	ctrl.write('set %s.1.27 type "CA"\n'%vxi)
	ctrl.write('set %s.1.28 type "HA"\n'%vxi)
	ctrl.write('set %s.1.29 type "CB"\n'%vxi)
