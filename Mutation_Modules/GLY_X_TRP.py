...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@O :{}@H1 0 0'.format(vxi, vxi)).execute()
                ...
                change(parm, 'charge', ':{}@CZ2'.format(vxi), bc['CZ2']).execute()
                change(parm, 'charge', ':{}@HZ2'.format(vxi), bc['HZ2']).execute()
                change(parm, 'charge', ':{}@CH2'.format(vxi), bc['CH2']).execute()
                change(parm, 'charge', ':{}@HH2'.format(vxi), bc['HH2']).execute()
                change(parm, 'charge', ':{}@CZ3'.format(vxi), bc['CZ3']).execute()
                change(parm, 'charge', ':{}@HZ3'.format(vxi), bc['HZ3']).execute()
