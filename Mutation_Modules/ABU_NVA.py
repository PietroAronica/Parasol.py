	...
	pdb = open(out, 'w')
        ...
        for res in struct.residue_list:
			...
			if atom.get_name() == 'HG3' and res.get_resname() == vxi:
                        	...
                        	pdb.write(atom.superimposed3('HD3', HG1))
			else:
                        	pdb.write(atom.formatted())
                try:
...
def lib_make(ff, outputfile, vxi='VXI', metcar='dc', methyd='dh', hydhyd='mh'):
	...
	ctrl.write("%s=loadpdb Param_files/LibPDB/NVA-ABU.pdb\n"%vxi)
	...
	ctrl.write('set %s.1.15 name "HD3"\n'%vxi)
...
def stock_add_to_all(metcar='dc', methyd='dh', hydhyd='mh'):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('HC', 'CT', metcar), cal2(p['C_C_H'][0], p['C_C_H'][0], i), cal2(p['C_C_H'][1], p['C_C_H'][1], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', metcar, methyd), cal2(p['H_C_C_H'][0], p['0_1'][0], i), cal2(p['H_C_C_H'][1], p['0_1'][1], i), cal2(p['H_C_C_H'][2], p['0_1'][2], i), cal2(p['H_C_C_H'][3], p['0_1'][3], i))
