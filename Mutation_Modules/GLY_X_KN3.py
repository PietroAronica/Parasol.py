...
def lib_make(ff, outputfile, vxi='VXI', var=variablemake()):
	...
	newoxy = var[8]
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/GLY_X_KN3.pdb\n"%vxi)
	...
	ctrl.write('set %s.1.25 element "N"\n'%vxi)
	...
	ctrl.write('set %s.1.21 name "CE"\n'%vxi)
	ctrl.write('set %s.1.22 name "HE2"\n'%vxi)
	ctrl.write('set %s.1.23 name "HE3"\n'%vxi)
	ctrl.write('set %s.1.24 name "NZ"\n'%vxi)
	ctrl.write('set %s.1.25 name "NH"\n'%vxi)
	ctrl.write('set %s.1.26 name "NT"\n'%vxi)
	...
	ctrl.write('set %s.1.22 type "HP"\n'%vxi)
	ctrl.write('set %s.1.23 type "HP"\n'%vxi)
	ctrl.write('set %s.1.24 type "NI"\n'%vxi)
	ctrl.write('set %s.1.25 type "ND"\n'%vxi)
	ctrl.write('set %s.1.26 type "NE"\n'%vxi)
