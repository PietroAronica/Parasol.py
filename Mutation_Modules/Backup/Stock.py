...
class vxier(object):
    ...
    def superimpose_atom_1(self, atom, hetfield, segid, atom_number, resname,
	...
	z = zz - 0.001
        ...
        args = (record_type, atom_number, name, altloc, resname, chain_id,
                ...
                element, charge)
        return _ATOM_FORMAT_STRING % args
    def superimpose_atom_2(self, atom, hetfield, segid, atom_number, resname,
                       resseq, icode, chain_id, xx, yy, zz, newname, charge="  "):
        """Returns an ATOM PDB string (PRIVATE)."""
        if hetfield != " ":
            record_type = "HETATM"
	...
	z = zz - 0.002
        ...
        args = (record_type, atom_number, name, altloc, resname, chain_id,
                ...
                element, charge)
        return _ATOM_FORMAT_STRING % args
    def superimpose_atom_3(self, atom, hetfield, segid, atom_number, resname,
                       resseq, icode, chain_id, xx, yy, zz, newname, charge="  "):
        """Returns an ATOM PDB string (PRIVATE)."""
        if hetfield != " ":
            record_type = "HETATM"
	...
	z = zz + 0.001
        ...
        args = (record_type, atom_number, name, altloc, resname, chain_id,
                ...
                element, charge)
        return _ATOM_FORMAT_STRING % args
    def put_atom_between(self, atom, hetfield, segid, atom_number, resname,
                       resseq, icode, chain_id, xx1, yy1, zz1, xx2, yy2, zz2, newname, charge="  "):
        """Returns an ATOM PDB string (PRIVATE)."""
        if hetfield != " ":
            record_type = "HETATM"
        else:
    ...
    def save(self, file, vxi, select=Select(), write_end=True):
        """
	...
	superimpose_atom_1 = self.superimpose_atom_1
	superimpose_atom_2 = self.superimpose_atom_2
	superimpose_atom_3 = self.superimpose_atom_3
	put_atom_between = self.put_atom_between
