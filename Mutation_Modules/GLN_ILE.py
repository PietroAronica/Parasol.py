...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                changeLJPair(parm, ':{}@HG12 :{}@OE1 0 0'.format(vxi, vxi)).execute()
                changeLJPair(parm, ':{}@HG12 :{}@NE2 0 0'.format(vxi, vxi)).execute()
                changeLJPair(parm, ':{}@HG12 :{}@HE21 0 0'.format(vxi, vxi)).execute()
	...
	pdb = open(out, 'w')
        ...
        for res in struct.residue_list:
			...
			if atom.get_name() == 'HB2' and res.get_resname() == vxi:
                        	...
                        	pdb.write(atom.formatted())
                        	pdb.write(atom.superimposed1('HG12', CD))
...
def lib_make(ff, outputfile, vxi='VXI', metcar1='1c', methyd1='1h', hydhyd1='xh', metcar2='2c', methyd2='2h', hydhyd2='yh', amicar='ca', amioxy='oa', aminit='na', amihyd='ha', hydhyd3='sh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/ILE-GLN.pdb\n"%vxi)
	...
	ctrl.write('set %s.1.21 name "CD1"\n'%vxi)
	ctrl.write('set %s.1.22 name "HD11"\n'%vxi)
	ctrl.write('set %s.1.23 name "HD12"\n'%vxi)
	ctrl.write('set %s.1.24 name "HD13"\n'%vxi)
...
def stock_add_to_all(vxi='VXI', metcar1='1c', methyd1='1h', hydhyd1='xh', metcar2='2c', methyd2='2h', hydhyd2='yh', amicar='ca', amioxy='oa', aminit='na', amihyd='ha', hydhyd3='sh'):
