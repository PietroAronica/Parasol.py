...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                changeLJPair(parm, ':{}@HG12'.format(vxi), ':{}@OE1'.format(vxi), '0', '0').execute()
                changeLJPair(parm, ':{}@HG12'.format(vxi), ':{}@NE2'.format(vxi), '0', '0').execute()
                changeLJPair(parm, ':{}@HG12'.format(vxi), ':{}@HE21'.format(vxi), '0', '0').execute()
