...
def parmed_command(vxi='VXI', lipid='No'):
	bc = {}
        ...
        b.close()
	fc = {}
        with open('Param_files/AminoAcid/B2E.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
		key, value = line.split()
		fc[key] = float(value)
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                change(parm, 'charge', ':{}@OE1'.format(vxi), bc['OE1']+((fc['OE1']-bc['OE1'])/10)*i).execute()
                change(parm, 'charge', ':{}@OE2'.format(vxi), bc['OE2']+((fc['OE2']-bc['OE2'])/10)*i).execute()
...
def lib_make(ff, outputfile, vxi='VXI', var=variablemake()):
	...
	ih = var[1]
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/GLU-B2E.pdb\n"%vxi)
...
def stock_add_to_all(var=variablemake()):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('C ', 'CX', ic), cal(p['N_CT_C'][0], p['CT_CT_C'][0], i), cal(p['N_CT_C'][1], p['CT_CT_C'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('H1', 'CX', ic), cal(p['C_C_H'][0], p['C_C_H'][0], i), cal(p['C_C_H'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('2C', 'CX', ic), cal(p['CT_CT_N'][0], p['C_C_C'][0], i), cal(p['CT_CT_N'][1], p['C_C_C'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CX', ic, ih), cal(p['Dritt'][0], p['C_C_H'][0], i), cal(p['Dritt'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CX', ic, 'N '), cal(p['Dritt'][0], p['CT_CT_N'][0], i), cal(p['Dritt'][1], p['CT_CT_N'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(ic, 'N ', 'C '), cal(p['C_N_CT'][0], p['C_N_CT'][0], i), cal(p['C_N_CT'][1], p['C_N_CT'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CX', ic, 'N '), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', 'CX', ic, ih), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', 'CX', ic, 'N '), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('2C', 'CX', ic, ih), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('2C', 'CX', ic, 'N '), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CX', ic, 'N ', 'C '), cal(p['0_3'][0], p['C_C_N_C_1'][0], i), cal(p['0_3'][1], p['C_C_N_C_1'][1], i), cal(p['0_3'][2], p['C_C_N_C_1'][2], i), cal(p['0_3'][3], p['C_C_N_C_1'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CX', ic, 'N ', 'C '), cal(p['0_8'][0], p['C_C_N_C_2'][0], i), cal(p['0_8'][1], p['C_C_N_C_2'][1], i), cal(p['0_8'][2], p['C_C_N_C_2'][2], i), cal(p['0_8'][3], p['C_C_N_C_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CX', ic, 'N ', 'C '), cal(p['0_2'][0], p['C_C_N_C_3'][0], i), cal(p['0_2'][1], p['C_C_N_C_3'][1], i), cal(p['0_2'][2], p['C_C_N_C_3'][2], i), cal(p['0_2'][3], p['C_C_N_C_3'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CX', ic, 'N ', 'C '), cal(p['0_7'][0], p['C_C_N_C_4'][0], i), cal(p['0_7'][1], p['C_C_N_C_4'][1], i), cal(p['0_7'][2], p['C_C_N_C_4'][2], i), cal(p['0_7'][3], p['C_C_N_C_4'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CX', ic, 'N ', 'H '), cal(p['X_C_N_X'][0], p['X_C_N_X'][0], i), cal(p['X_C_N_X'][1], p['X_C_N_X'][1], i), cal(p['X_C_N_X'][2], p['X_C_N_X'][2], i), cal(p['X_C_N_X'][3], p['X_C_N_X'][3], i))
