...
def parmed_command(vxi='VXI', lipid='No'):
	bc = {}
        with open('Param_files/AminoAcid/HE1.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
        ...
        b.close()
	fc = {}
        with open('Param_files/AminoAcid/AnE.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
		key, value = line.split()
		fc[key] = float(value)
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@HG2'.format(vxi), ':{}@HE2'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HG3'.format(vxi), ':{}@HE3'.format(vxi), '0', '0').execute()
                ...
                change(parm, 'charge', ':{}@HE2'.format(vxi), bc['HD2']-(bc['HD2']/10)*i).execute()
                change(parm, 'charge', ':{}@HE3'.format(vxi), bc['HD3']-(bc['HD3']/10)*i).execute()
                change(parm, 'charge', ':{}@CZ'.format(vxi), bc['CE']+((fc['CZ']-bc['CE'])/10)*i).execute()
                change(parm, 'charge', ':{}@OH1'.format(vxi), bc['OZ1']+((fc['OH1']-bc['OZ1'])/10)*i).execute()
                change(parm, 'charge', ':{}@OH2'.format(vxi), bc['OZ2']+((fc['OH2']-bc['OZ2'])/10)*i).execute()
...
def makevxi(struct, out, aa, vxi='VXI'):
	...
	pdb = open(out, 'w')
		...
		for atom in res.atom_list:
			...
			elif atom.get_name() == 'OZ1' and res.get_resname() == vxi:
				pdb.write(atom.change_name('OH1')) 
			elif atom.get_name() == 'OZ2' and res.get_resname() == vxi:
...
def lib_make(ff, outputfile, vxi='VXI', var=variablemake()):
	...
	hd3 = var[10]
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/HE1-AnE.pdb\n"%vxi)
	...
	ctrl.write('set %s.1.18 name "CZ"\n'%vxi)
	ctrl.write('set %s.1.19 name "OH1"\n'%vxi)
	ctrl.write('set %s.1.20 name "OH2"\n'%vxi)
	...
	ctrl.write('set %s.1.19 type "O2"\n'%vxi)
	ctrl.write('set %s.1.20 type "O2"\n'%vxi)
...
def stock_add_to_all(var=variablemake()):
	...
	for i in range(11):
		...
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(cd, 'C '), lac(p['CA_C'][0], p['CT_C'][0], i), lac(p['CA_C'][1], p['CT_C'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cd, 'C ', 'O2'), lac(p['CA_C_O2'][0], p['C_C_O2'][0], i), lac(p['CA_C_O2'][1], p['C_C_O2'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hd2, cd, 'C '), lac(p['A_CA_CA_HA'][0], p['C_C_H'][0], i), lac(p['A_CA_CA_HA'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hd3, cd, 'C '), lac(p['A_CA_CA_HA'][0], p['C_C_H'][0], i), lac(p['A_CA_CA_HA'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('C ', cd, cd1), lac(p['A_CA_CA_HA'][0], p['C_C_H'][0], i), lac(p['A_CA_CA_HA'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('C ', cd, cd2), lac(p['A_CA_CA_HA'][0], p['C_C_H'][0], i), lac(p['A_CA_CA_HA'][1], p['C_C_H'][1], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', cd, cd1, hd11), lac(p['Ring_Dihe'][0], p['Ring_0'][0], i), lac(p['Ring_Dihe'][1], p['Ring_0'][1], i), lac(p['Ring_Dihe'][2], p['Ring_0'][2], i), lac(p['Ring_Dihe'][3], p['Ring_0'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', cd, cd2, hd21), lac(p['Ring_Dihe'][0], p['Ring_0'][0], i), lac(p['Ring_Dihe'][1], p['Ring_0'][1], i), lac(p['Ring_Dihe'][2], p['Ring_0'][2], i), lac(p['Ring_Dihe'][3], p['Ring_0'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd1, cd, 'C '), lac(p['Ring_Dihe'][0], p['Ring_0'][0], i), lac(p['Ring_Dihe'][1], p['Ring_0'][1], i), lac(p['Ring_Dihe'][2], p['Ring_0'][2], i), lac(p['Ring_Dihe'][3], p['Ring_0'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd2, cd, 'C '), lac(p['Ring_Dihe'][0], p['Ring_0'][0], i), lac(p['Ring_Dihe'][1], p['Ring_0'][1], i), lac(p['Ring_Dihe'][2], p['Ring_0'][2], i), lac(p['Ring_Dihe'][3], p['Ring_0'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('X ', cd, 'C ', 'X '), lac(p['Ring_Dihe'][0], p['Ring_0'][0], i), lac(p['Ring_Dihe'][1], p['Ring_0'][1], i), lac(p['Ring_Dihe'][2], p['Ring_0'][2], i), lac(p['Ring_Dihe'][3], p['Ring_0'][3], i))
