...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@HB2'.format(vxi), ':{}@HD11'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HB2'.format(vxi), ':{}@HD21'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HB3'.format(vxi), ':{}@HD11'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HB3'.format(vxi), ':{}@HD21'.format(vxi), '0', '0').execute()
