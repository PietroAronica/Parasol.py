...
def lib_make(ff, outputfile, vxi='VXI', alcoxy='ho', alchyd='hh', hydhyd2='rh', serhyd='fh', amicar='ac', amioxy='ao', aminit='an', amihyd='ah', hydhyd1='sh'):
        ctrl = open('lyp.in', 'w')
...
def stock_add_to_all(alcoxy='ho', alchyd='hh', hydhyd2='rh', serhyd='fh', amicar='ac', amioxy='ao', aminit='an', amihyd='ah', hydhyd1='sh'):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(serhyd, 'CT', amicar), cal2(p['C_C_H'][0], p['C_C_H'][0], i), cal2(p['C_C_H'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(serhyd, 'CT', hydhyd1), cal2(p['H_C_H'][0], p['H_C_H'][0], i), cal2(p['H_C_H'][1], p['H_C_H'][1], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(serhyd, 'CT', amicar, aminit), cal2(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal2(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal2(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal2(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(serhyd, 'CT', amicar, amioxy), cal2(p['H_C_C_O_1'][0], p['0_10'][0], i), cal2(p['H_C_C_O_1'][1], p['0_10'][1], i), cal2(p['H_C_C_O_1'][2], p['0_10'][2], i), cal2(p['H_C_C_O_1'][3], p['0_10'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(serhyd, 'CT', amicar, amioxy), cal2(p['H_C_C_O_2'][0], p['0_8'][0], i), cal2(p['H_C_C_O_2'][1], p['0_8'][1], i), cal2(p['H_C_C_O_2'][2], p['0_8'][2], i), cal2(p['H_C_C_O_2'][3], p['0_8'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(serhyd, 'CT', amicar, amioxy), cal2(p['H_C_C_O_3'][0], p['0_9'][0], i), cal2(p['H_C_C_O_3'][1], p['0_9'][1], i), cal2(p['H_C_C_O_3'][2], p['0_9'][2], i), cal2(p['H_C_C_O_3'][3], p['0_9'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(alcoxy, 'CT', amicar, amioxy), cal2(p['0_Dihe'][0], p['0_Dihe'][0], i), cal2(p['0_Dihe'][1], p['0_Dihe'][1], i), cal2(p['0_Dihe'][2], p['0_Dihe'][2], i), cal2(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(alcoxy, 'CT', amicar, aminit), cal2(p['0_Dihe'][0], p['0_Dihe'][0], i), cal2(p['0_Dihe'][1], p['0_Dihe'][1], i), cal2(p['0_Dihe'][2], p['0_Dihe'][2], i), cal2(p['0_Dihe'][3], p['0_Dihe'][3], i))
