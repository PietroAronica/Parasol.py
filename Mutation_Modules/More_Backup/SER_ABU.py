...
def stock_add_to_all(metcar='dc', methyd='dh', hydhyd1='mh', alcoxy='ho', alchyd='hh', hydhyd2='sh', serhyd='fh'):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', hydhyd2), cal(p['C_C_H'][0], p['C_C_H'][0], i), cal(p['C_C_H'][1], p['C_C_H'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(serhyd, 'CT', metcar, methyd), cal2(p['X_C_C_X'][0], p['0_1'][0], i), cal2(p['X_C_C_X'][1], p['0_1'][1], i), cal2(p['X_C_C_X'][2], p['0_1'][2], i), cal2(p['X_C_C_X'][3], p['0_1'][3], i))
