	...
	pdb = open(out, 'w')
        ...
        for res in struct.residue_list:
			...
			if atom.get_name() == 'HB3' and res.get_resname() == vxi:
                        	...
                        	pdb.write(atom.halfway_between('CG', CB, HB1))
                        	pdb.write(atom.superimposed1('OD1', HB1))
                        	pdb.write(atom.superimposed2('ND2', HB1))
                        	pdb.write(atom.halfway_after1('HD21', CB, HB1))
                        	pdb.write(atom.halfway_after2('HD22', CB, HB1))
			else:
                        	pdb.write(atom.formatted())
                try:
...
def lib_make(ff, outputfile, vxi='VXI', amicar='ac', amioxy='ao', aminit='an', amihyd='ah', hydhyd='sh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source leaprc.%s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/ASN-ALA.pdb\n"%vxi)
...
def stock_add_to_all(amicar='ac', amioxy='ao', aminit='an', amihyd='ah', hydhyd='sh'):
	...
	for i in range(11):
		...
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CT', hydhyd), cal2(p['HC_sC2'][0], p['CT_HC'][0], i), cal2(p['HC_sC2'][1], p['CT_HC'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('HC', 'CT', amicar), cal2(p['C_C_H'][0], p['C_C_H'][0], i), cal2(p['C_C_H'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('HC', 'CT', hydhyd), cal2(p['H_C_H'][0], p['H_C_H'][0], i), cal2(p['H_C_H'][1], p['H_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd, 'CT', amicar), cal2(p['Close'][0], p['Close'][0], i), cal2(p['Close'][1], p['Close'][1], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', amicar, aminit), cal2(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal2(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal2(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal2(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', amicar, amioxy), cal2(p['H_C_C_O_1'][0], p['0_10'][0], i), cal2(p['H_C_C_O_1'][1], p['0_10'][1], i), cal2(p['H_C_C_O_1'][2], p['0_10'][2], i), cal2(p['H_C_C_O_1'][3], p['0_10'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', amicar, amioxy), cal2(p['H_C_C_O_2'][0], p['0_8'][0], i), cal2(p['H_C_C_O_2'][1], p['0_8'][1], i), cal2(p['H_C_C_O_2'][2], p['0_8'][2], i), cal2(p['H_C_C_O_2'][3], p['0_8'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', amicar, amioxy), cal2(p['H_C_C_O_3'][0], p['0_9'][0], i), cal2(p['H_C_C_O_3'][1], p['0_9'][1], i), cal2(p['H_C_C_O_3'][2], p['0_9'][2], i), cal2(p['H_C_C_O_3'][3], p['0_9'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd, 'CT', amicar, amioxy), cal2(p['0_Dihe'][0], p['0_Dihe'][0], i), cal2(p['0_Dihe'][1], p['0_Dihe'][1], i), cal2(p['0_Dihe'][2], p['0_Dihe'][2], i), cal2(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd, 'CT', amicar, aminit), cal2(p['0_Dihe'][0], p['0_Dihe'][0], i), cal2(p['0_Dihe'][1], p['0_Dihe'][1], i), cal2(p['0_Dihe'][2], p['0_Dihe'][2], i), cal2(p['0_Dihe'][3], p['0_Dihe'][3], i))
