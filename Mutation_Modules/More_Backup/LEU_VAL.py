...
def stock_add_to_all(metcar1='1c', methyd1='1h', hydhyd1='xh', metcar2='2c', methyd2='2h', hydhyd2='yh', metcar3='3c', methyd3='3h', hydhyd3='zh'):
	...
	Frcmod_creator.TYPE_insert(hydhyd3, 'H', 'sp3')
		...
		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), metcar3, cal2(p['CT'][0], p['0_C'][0], i), cal2(p['CT'][1], p['0_C'][1], i))
		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), methyd3, cal2(p['HC'][0], p['0_H'][0], i), cal2(p['HC'][1], p['0_H'][1], i))
		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), hydhyd3, cal2(p['0_H'][0], p['HC'][0], i), cal2(p['0_H'][1], p['HC'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CT', metcar3), cal2(p['CT_CT'][0], p['CT_mH'][0], i), cal2(p['CT_CT'][1], p['CT_mH'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CT', hydhyd3), cal2(p['HC_sC'][0], p['CT_HC'][0], i), cal2(p['HC_sC'][1], p['CT_HC'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(metcar3, methyd3), cal2(p['CT_HC'][0], p['HC_mH'][0], i), cal2(p['CT_HC'][1], p['HC_mH'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', metcar3, methyd3), cal2(p['C_C_H'][0], p['Dritt'][0], i), cal2(p['C_C_H'][1], p['Dritt'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(methyd3, metcar3, methyd3), cal2(p['H_C_H'][0], p['Close'][0], i), cal2(p['H_C_H'][1], p['Close'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', metcar3), cal2(p['C_C_C'][0], p['C_C_C'][0], i), cal2(p['C_C_C'][1], p['C_C_C'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('HC', 'CT', metcar3), cal2(p['C_C_H'][0], p['C_C_H'][0], i), cal2(p['C_C_H'][1], p['C_C_H'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd3, 'CT', metcar3), cal2(p['Close'][0], p['Close'][0], i), cal2(p['Close'][1], p['Close'][1], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', metcar3, methyd3), cal2(p['C_C_C_H'][0], p['0_1'][0], i), cal2(p['C_C_C_H'][1], p['0_1'][1], i), cal2(p['C_C_C_H'][2], p['0_1'][2], i), cal2(p['C_C_C_H'][3], p['0_1'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', metcar3, methyd3), cal2(p['H_C_C_H'][0], p['0_1'][0], i), cal2(p['H_C_C_H'][1], p['0_1'][1], i), cal2(p['H_C_C_H'][2], p['0_1'][2], i), cal2(p['H_C_C_H'][3], p['0_1'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd3, 'CT', metcar3, methyd3), cal2(p['0_Dihe'][0], p['0_Dihe'][0], i), cal2(p['0_Dihe'][1], p['0_Dihe'][1], i), cal2(p['0_Dihe'][2], p['0_Dihe'][2], i), cal2(p['0_Dihe'][3], p['0_Dihe'][3], i))
		Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), metcar3, cal2(p['CT'][2], p['0_C'][2], i), cal2(p['CT'][3], p['0_C'][3], i))
		Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), methyd3, cal2(p['HC'][2], p['0_H'][2], i), cal2(p['HC'][3], p['0_H'][3], i))
