...
def parmed_command(vxi='VXI'):
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                changeLJPair(parm, ':{}@HG21 :{}@HD1 0 0'.format(vxi, vxi)).execute()
...
def lib_make(ff, outputfile, vxi='VXI', metcar='2c', methyd='2h', hydhyd1='yh', alcoxy='ho', alchyd='hh', hydhyd2='sh', thrhyd='fh'):
        ctrl = open('lyp.in', 'w')
...
def stock_add_to_all(vxi='VXI', metcar='2c', methyd='2h', hydhyd1='yh', alcoxy='ho', alchyd='hh', hydhyd2='sh', thrhyd='fh'):
