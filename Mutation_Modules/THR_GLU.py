	...
	pdb = open(out, 'w')
        ...
        for res in struct.residue_list:
			...
			if atom.get_name() == 'HB' and res.get_resname() == vxi:
                        	...
                        	pdb.write(atom.superimposed2('OE2', HG21))
			else:
...
def lib_make(ff, outputfile, vxi='VXI', carcar='cc', caroxy='oc', hydhyd1='yh', alcoxy='oh', alchyd='hh', hydhyd2='sh', thrhyd='hf'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
...
def stock_add_to_all(vxi='VXI', carcar='cc', caroxy='oc', hydhyd1='yh', alcoxy='oh', alchyd='hh', hydhyd2='sh', thrhyd='hf'):
