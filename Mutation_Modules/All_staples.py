...
def parmed_command_ABX_N(vx1):
	bc = {}
        ...
        b.close()
	fc = {}
        with open('Param_files/AminoAcid/NABX.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
		key, value = line.split()
		fc[key] = float(value)
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                change(parm, 'charge', ':{}@N'.format(vx1), bc['N']+((fc['N']-bc['N'])/10)*i).execute()
                change(parm, 'charge', ':{}@H1'.format(vx1), bc['H1']+((fc['H1']-bc['H1'])/10)*i).execute()
                change(parm, 'charge', ':{}@H2'.format(vx1), bc['H2']+((fc['H2']-bc['H2'])/10)*i).execute()
                change(parm, 'charge', ':{}@H3'.format(vx1), bc['H3']+((fc['H3']-bc['H3'])/10)*i).execute()
                change(parm, 'charge', ':{}@CA'.format(vx1), bc['CA']+((fc['CA']-bc['CA'])/10)*i).execute()
                change(parm, 'charge', ':{}@HA'.format(vx1), bc['HA']+((fc['HA']-bc['HA'])/10)*i).execute()
                change(parm, 'charge', ':{}@CB'.format(vx1), bc['CB']+((fc['CB']-bc['CB'])/10)*i).execute()
                change(parm, 'charge', ':{}@HB2'.format(vx1), bc['HB2']+((fc['HB2']-bc['HB2'])/10)*i).execute()
...
def parmed_command_CYX_N(vx1):
	bc = {}
        with open('Param_files/AminoAcid/NCYS.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
		key, value = line.split()
		bc[key] = float(value)
...
def parmed_command_GCX_C(vx1):
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                change(parm, 'charge', ':{}@H'.format(vx1), bc['H']+((fc['H']-bc['H'])/10)*i).execute()
                change(parm, 'charge', ':{}@CA'.format(vx1), bc['CA']+((fc['CA']-bc['CA'])/10)*i).execute()
                change(parm, 'charge', ':{}@HA2'.format(vx1), bc['HA2']+((fc['HA2']-bc['HA2'])/10)*i).execute()
                change(parm, 'charge', ':{}@HA3'.format(vx1), bc['HA3']+((fc['HA3']-bc['HA3'])/10)*i).execute()
                change(parm, 'charge', ':{}@C'.format(vx1), bc['C']+((fc['C']-bc['C'])/10)*i).execute()
                change(parm, 'charge', ':{}@O'.format(vx1), bc['O']+((fc['O']-bc['O'])/10)*i).execute()
...
def parmed_command_GNX_N(vx1):
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                change(parm, 'charge', ':{}@N'.format(vx1), bc['N']+((fc['N']-bc['N'])/10)*i).execute()
                change(parm, 'charge', ':{}@H'.format(vx1), bc['H1']+((fc['H']-bc['H1'])/10)*i).execute()
                change(parm, 'charge', ':{}@H2'.format(vx1), bc['H2']-(bc['H2']/10)*i).execute()
                change(parm, 'charge', ':{}@H3'.format(vx1), bc['H3']-(bc['H3']/10)*i).execute()
                change(parm, 'charge', ':{}@CA'.format(vx1), bc['CA']+((fc['CA']-bc['CA'])/10)*i).execute()
                change(parm, 'charge', ':{}@HA2'.format(vx1), bc['HA2']+((fc['HA2']-bc['HA2'])/10)*i).execute()
                change(parm, 'charge', ':{}@HA3'.format(vx1), bc['HA3']+((fc['HA3']-bc['HA3'])/10)*i).execute()
                change(parm, 'charge', ':{}@C'.format(vx1), bc['C']+((fc['C']-bc['C'])/10)*i).execute()
...
def parmed_command_FCX_C(vx1):
	bc = {}
        with open('Param_files/AminoAcid/CPHE.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
		key, value = line.split()
		bc[key] = float(value)
	...
	for i in range(11):
		...
		parm = AmberParm('Solv_{}_{}.prmtop'.format(a, 100-a))
                ...
                change(parm, 'charge', ':{}@HB3'.format(vx1), bc['HB3']+((fc['HB3']-bc['HB3'])/10)*i).execute()
                change(parm, 'charge', ':{}@CG'.format(vx1), bc['CG']+((fc['CG']-bc['CG'])/10)*i).execute()
                change(parm, 'charge', ':{}@CD1'.format(vx1), bc['CD1']+((fc['CD1']-bc['CD1'])/10)*i).execute()
                change(parm, 'charge', ':{}@HD1'.format(vx1), bc['HD1']+((fc['HD1']-bc['HD1'])/10)*i).execute()
                change(parm, 'charge', ':{}@CE1'.format(vx1), bc['CE1']+((fc['CE1']-bc['CE1'])/10)*i).execute()
                change(parm, 'charge', ':{}@HE1'.format(vx1), bc['HE1']+((fc['HE1']-bc['HE1'])/10)*i).execute()
                change(parm, 'charge', ':{}@CZ'.format(vx1), bc['CZ']+((fc['CZ']-bc['CZ'])/10)*i).execute()
                change(parm, 'charge', ':{}@HZ'.format(vx1), bc['HZ']+((fc['HZ']-bc['HZ'])/10)*i).execute()
                ...
                change(parm, 'charge', ':{}@CD2'.format(vx1), bc['CD2']+((fc['CD2']-bc['CD2'])/10)*i).execute()
...
def parmed_command_PCX_C(vx1):
	bc = {}
        with open('Param_files/AminoAcid/CPRO.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
		key, value = line.split()
		bc[key] = float(value)
...
def makevxi_GCX(struct, out, resid, vx1):
...
def makevxi_PCX(struct, out, resid, vx1):
        struct.residue_dict[resid].set_resname(vx1)
	pdb = open(out, 'w')
        try:
                pdb.write(struct.other_dict['Cryst1'].formatted())
...
def makevxi_FCX(struct, out, resid, vx1):
        struct.residue_dict[resid].set_resname(vx1)
	pdb = open(out, 'w')
        try:
                pdb.write(struct.other_dict['Cryst1'].formatted())
...
def makevxi_GNX(struct, out, resid, vx1):
        struct.residue_dict[resid].set_resname(vx1)
	pdb = open(out, 'w')
        try:
                pdb.write(struct.other_dict['Cryst1'].formatted())
        ...
        for res in struct.residue_list:
                for atom in res.atom_list:
			if atom.get_name() == 'H1' and res.get_resnumber() == resid:
...
def makevxi_HCX(struct, out, resid, vx1):
        struct.residue_dict[resid].set_resname(vx1)
	pdb = open(out, 'w')
        try:
                pdb.write(struct.other_dict['Cryst1'].formatted())
...
def lib_make_VLX(ff, outputfile, vxi, newcar='dc', gonhyd='dh'):
	...
	ctrl.write('set %s.1 connect2 %s.1.11\n'%(vxi, vxi))
...
def lib_make_GCX_C(ff, outputfile, vxi, difcar='c^', gonoxy='ok', difoxy='om'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/CGLY.pdb\n"%vxi)
	ctrl.write('set %s.1.1 element "N"\n'%vxi)
	ctrl.write('set %s.1.2 element "H"\n'%vxi)
	ctrl.write('set %s.1.3 element "C"\n'%vxi)
	ctrl.write('set %s.1.4 element "H"\n'%vxi)
	...
	ctrl.write('set %s.1.6 name "C"\n'%vxi)
	ctrl.write('set %s.1.7 name "O"\n'%vxi)
	ctrl.write('set %s.1.8 name "OXT"\n'%vxi)
	ctrl.write('set %s.1.1 type "N"\n'%vxi)
	ctrl.write('set %s.1.2 type "H"\n'%vxi)
	ctrl.write('set %s.1.3 type "CT"\n'%vxi)
	ctrl.write('set %s.1.4 type "H1"\n'%vxi)
...
def lib_make_PCX_C(ff, outputfile, vxi, difcar='c^', gonoxy='ok', difoxy='om'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/CPRO.pdb\n"%vxi)
	ctrl.write('set %s.1.1 element "N"\n'%vxi)
	...
	ctrl.write('set %s.1.7 name "CG"\n'%vxi)
	ctrl.write('set %s.1.8 name "HG2"\n'%vxi)
	ctrl.write('set %s.1.9 name "HG3"\n'%vxi)
	ctrl.write('set %s.1.10 name "CD"\n'%vxi)
	ctrl.write('set %s.1.11 name "HD2"\n'%vxi)
	ctrl.write('set %s.1.12 name "HD3"\n'%vxi)
	ctrl.write('set %s.1.13 name "C"\n'%vxi)
	ctrl.write('set %s.1.14 name "O"\n'%vxi)
	ctrl.write('set %s.1.15 name "OXT"\n'%vxi)
	ctrl.write('set %s.1.1 type "N"\n'%vxi)
...
def lib_make_FCX_C(ff, outputfile, vxi, difcar='c^', gonoxy='ok', difoxy='om'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/CPHE.pdb\n"%vxi)
	ctrl.write('set %s.1.1 element "N"\n'%vxi)
	ctrl.write('set %s.1.2 element "H"\n'%vxi)
	ctrl.write('set %s.1.3 element "C"\n'%vxi)
	ctrl.write('set %s.1.4 element "H"\n'%vxi)
	...
	ctrl.write('set %s.1.21 name "OXT"\n'%vxi)
	ctrl.write('set %s.1.1 type "N"\n'%vxi)
	ctrl.write('set %s.1.2 type "H"\n'%vxi)
	ctrl.write('set %s.1.3 type "CT"\n'%vxi)
	ctrl.write('set %s.1.4 type "H1"\n'%vxi)
...
def lib_make_GNX_N(ff, outputfile, vxi, difnit='n^', gonhyd='hk', difhyd='hm'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/NGLY.pdb\n"%vxi)
	ctrl.write('set %s.1.1 element "N"\n'%vxi)
	ctrl.write('set %s.1.2 element "H"\n'%vxi)
	ctrl.write('set %s.1.3 element "H"\n'%vxi)
	ctrl.write('set %s.1.4 element "H"\n'%vxi)
	...
	ctrl.write('set %s.1.6 name "HA2"\n'%vxi)
	ctrl.write('set %s.1.7 name "HA3"\n'%vxi)
	ctrl.write('set %s.1.8 name "C"\n'%vxi)
	ctrl.write('set %s.1.9 name "O"\n'%vxi)
...
def lib_make_CYX_N(ff, outputfile, vxi, newsul='ds', gonhyd='dh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/NCYX.pdb\n"%vxi)
	ctrl.write('set %s.1.1 element "N"\n'%vxi)
	ctrl.write('set %s.1.2 element "H"\n'%vxi)
	ctrl.write('set %s.1.3 element "H"\n'%vxi)
	ctrl.write('set %s.1.4 element "H"\n'%vxi)
...
def lib_make_HCX(ff, outputfile, vxi, newsul='ds', gonhyd='dh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/HCX.pdb\n"%vxi)
	ctrl.write('set %s.1.1 element "N"\n'%vxi)
	ctrl.write('set %s.1.2 element "H"\n'%vxi)
	ctrl.write('set %s.1.3 element "C"\n'%vxi)
	ctrl.write('set %s.1.4 element "H"\n'%vxi)
...
def lib_make_ABX_N(ff, outputfile, vxi, newcar='dc', gonhyd='dh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/NABX.pdb\n"%vxi)
	ctrl.write('set %s.1.1 element "N"\n'%vxi)
	ctrl.write('set %s.1.2 element "H"\n'%vxi)
	ctrl.write('set %s.1.3 element "H"\n'%vxi)
	ctrl.write('set %s.1.4 element "H"\n'%vxi)
	...
	ctrl.write('set %s.1.11 name "HG1"\n'%vxi)
	ctrl.write('set %s.1.12 name "HG2"\n'%vxi)
	ctrl.write('set %s.1.13 name "HG3"\n'%vxi)
	ctrl.write('set %s.1.14 name "C"\n'%vxi)
	ctrl.write('set %s.1.15 name "O"\n'%vxi)
	ctrl.write('set %s.1.1 type "N3"\n'%vxi)
	ctrl.write('set %s.1.2 type "H"\n'%vxi)
	ctrl.write('set %s.1.3 name "H"\n'%vxi)
...
def lib_make_ALX(ff, outputfile, vxi, newcar='dc', gonhyd='dh'):
	...
	ctrl.write('set %s.1 connect0 %s.1.N\n'%(vxi, vxi))
	ctrl.write('set %s.1 connect1 %s.1.C\n'%(vxi, vxi))
	ctrl.write('set %s.1 connect2 %s.1.5\n'%(vxi, vxi))
	ctrl.write('set %s name "%s"\n'%(vxi, vxi))
	ctrl.write('set %s.1 name "%s"\n'%(vxi, vxi))
	ctrl.write('set %s head %s.1.N\n'%(vxi, vxi))
	ctrl.write('set %s tail %s.1.C\n'%(vxi, vxi))
...
def lib_make_I4X(ff, outputfile, vxi, newcar='dc', newhyd='dh', gonhyd='gh', metcar='mc', methyd='mh', hydhyd='hh'):
	...
	ctrl.write('set %s.1 connect0 %s.1.N\n'%(vxi, vxi))
	ctrl.write('set %s.1 connect1 %s.1.C\n'%(vxi, vxi))
	ctrl.write('set %s.1 connect2 %s.1.18\n'%(vxi, vxi))
	ctrl.write('set %s name "%s"\n'%(vxi, vxi))
	ctrl.write('set %s.1 name "%s"\n'%(vxi, vxi))
	ctrl.write('set %s head %s.1.N\n'%(vxi, vxi))
	ctrl.write('set %s tail %s.1.C\n'%(vxi, vxi))
...
def lib_make_I7X(ff, outputfile, vxi, newcar='dc', newhyd='dh', gonhyd='gh', metcar='mc', methyd='mh', hydhyd='hh'):
	...
	ctrl.write('set %s.1 connect0 %s.1.N\n'%(vxi, vxi))
	ctrl.write('set %s.1 connect1 %s.1.C\n'%(vxi, vxi))
	ctrl.write('set %s.1 connect2 %s.1.27\n'%(vxi, vxi))
	ctrl.write('set %s name "%s"\n'%(vxi, vxi))
	ctrl.write('set %s.1 name "%s"\n'%(vxi, vxi))
	ctrl.write('set %s head %s.1.N\n'%(vxi, vxi))
	ctrl.write('set %s tail %s.1.C\n'%(vxi, vxi))
...
def stock_add_to_all_PCX(dist, difcar='c^', gonoxy='ok', difoxy='om'):
        p = {}
        with open('Param_files/Stock/Stock.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
        ...
        for i in range(11):
                a = i*10
                Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), difcar, cal(p['C'][0], p['C'][0], i), cal(p['C'][1], p['C'][1], i))
                Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), difoxy, cal(p['O2'][0], p['O2'][0], i), cal(p['O2'][1], p['O2'][1], i))
                Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), gonoxy, cal(p['O2'][0], p['0_O'][0], i), cal(p['O2'][1], p['0_O'][1], i))
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(difcar, difoxy), cal(p['C_O2'][0], p['C_O'][0], i), cal(p['C_O2'][1], p['C_O'][1], i))
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(difcar, gonoxy), cal(p['C_O2'][0], p['C_O'][0], i), cal(p['C_O2'][1], p['C_O'][1], i))
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(difcar, 'CT'), cal(p['CT_C'][0], p['CT_C'][0], i), cal(p['CT_C'][1], p['CT_C'][1], i))
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(difcar, 'n^'), cal(p['0_0'][0], p['C_N'][0], i), cal(dist, p['C_N'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', difcar, difoxy), cal(p['C_C_O2'][0], p['C_C_O'][0], i), cal(p['C_C_O2'][1], p['C_C_O'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', difcar, gonoxy), cal(p['C_C_O2'][0], p['C_C_O'][0], i), cal(p['C_C_O2'][1], p['C_C_O'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(gonoxy, difcar, difoxy), cal(p['O2_C_O2'][0], p['Close'][0], i), cal(p['O2_C_O2'][1], p['Close'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('n^', difcar, difoxy), cal(p['X_CM_CM_0'][0], p['O_C_N'][0], i), cal(p['X_CM_CM_0'][1], p['O_C_N'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('n^', difcar, gonoxy), cal(p['X_CM_CM_0'][0], p['O_C_N'][0], i), cal(p['X_CM_CM_0'][1], p['O_C_N'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('hk', 'n^', difcar), cal(p['X_CM_CM_0'][0], p['F_CA_CA_HA'][0], i), cal(p['X_CM_CM_0'][1], p['F_CA_CA_HA'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('hm', 'n^', difcar), cal(p['X_CM_CM_0'][0], p['F_CA_CA_HA'][0], i), cal(p['X_CM_CM_0'][1], p['F_CA_CA_HA'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'n^', difcar), cal(p['X_CM_CM_0'][0], p['C_N_CT'][0], i), cal(p['X_CM_CM_0'][1], p['C_N_CT'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', difcar, 'n^'), cal(p['X_CM_CM_0'][0], p['C_C_N'][0], i), cal(p['X_CM_CM_0'][1], p['C_C_N'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('H1', 'CT', difcar), cal(p['C_C_H'][0], p['C_C_H'][0], i), cal(p['C_C_H'][1], p['C_C_H'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('N ', 'CT', difcar), cal(p['N_CT_C'][0], p['N_CT_C'][0], i), cal(p['N_CT_C'][1], p['N_CT_C'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', difcar), cal(p['CT_CT_C'][0], p['CT_CT_C'][0], i), cal(p['CT_CT_C'][1], p['CT_CT_C'][1], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CT', difcar, difoxy), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CT', difcar, difoxy), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', difcar, difoxy), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', difcar, gonoxy), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CT', difcar, gonoxy), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CT', difcar, gonoxy), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('hk', 'n^', difcar, difoxy), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('hk', 'n^', difcar, gonoxy), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('hm', 'n^', difcar, gonoxy), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', difcar, 'n^'), cal(p['0_3'][0], p['C_C_N_C_1'][0], i), cal(p['0_3'][1], p['C_C_N_C_1'][1], i), cal(p['0_3'][2], p['C_C_N_C_1'][2], i), cal(p['0_3'][3], p['C_C_N_C_1'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', difcar, 'n^'), cal(p['0_8'][0], p['C_C_N_C_2'][0], i), cal(p['0_8'][1], p['C_C_N_C_2'][1], i), cal(p['0_8'][2], p['C_C_N_C_2'][2], i), cal(p['0_8'][3], p['C_C_N_C_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', difcar, 'n^'), cal(p['0_2'][0], p['C_C_N_C_3'][0], i), cal(p['0_2'][1], p['C_C_N_C_3'][1], i), cal(p['0_2'][2], p['C_C_N_C_3'][2], i), cal(p['0_2'][3], p['C_C_N_C_3'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', difcar, 'n^'), cal(p['0_7'][0], p['C_C_N_C_4'][0], i), cal(p['0_7'][1], p['C_C_N_C_4'][1], i), cal(p['0_7'][2], p['C_C_N_C_4'][2], i), cal(p['0_7'][3], p['C_C_N_C_4'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CT', difcar, 'n^'), cal(p['0_12'][0], p['N_CX_C_N_1'][0], i), cal(p['0_12'][1], p['N_CX_C_N_1'][1], i), cal(p['0_12'][2], p['N_CX_C_N_1'][2], i), cal(p['0_12'][3], p['N_CX_C_N_1'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CT', difcar, 'n^'), cal(p['0_11'][0], p['N_CX_C_N_2'][0], i), cal(p['0_11'][1], p['N_CX_C_N_2'][1], i), cal(p['0_11'][2], p['N_CX_C_N_2'][2], i), cal(p['0_11'][3], p['N_CX_C_N_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CT', difcar, 'n^'), cal(p['0_14'][0], p['N_CX_C_N_3'][0], i), cal(p['0_14'][1], p['N_CX_C_N_3'][1], i), cal(p['0_14'][2], p['N_CX_C_N_3'][2], i), cal(p['0_14'][3], p['N_CX_C_N_3'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CT', difcar, 'n^'), cal(p['0_7'][0], p['N_CX_C_N_4'][0], i), cal(p['0_7'][1], p['N_CX_C_N_4'][1], i), cal(p['0_7'][2], p['N_CX_C_N_4'][2], i), cal(p['0_7'][3], p['N_CX_C_N_4'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', difcar, 'n^', 'CT'), cal(p['0_18'][0], p['X_C_N_X_1000'][0], i), cal(p['0_18'][1], p['X_C_N_X_1000'][1], i), cal(p['0_18'][2], p['X_C_N_X_1000'][2], i), cal(p['0_18'][3], p['X_C_N_X_1000'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', difcar, 'n^', 'hm'), cal(p['0_17'][0], p['X_C_N_X_0'][0], i), cal(p['0_17'][1], p['X_C_N_X_0'][1], i), cal(p['0_17'][2], p['X_C_N_X_0'][2], i), cal(p['0_17'][3], p['X_C_N_X_0'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', difcar, 'n^', 'hk'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(difoxy, difcar, 'n^', 'CT'), cal(p['0_17'][0], p['X_C_N_X_0'][0], i), cal(p['0_17'][1], p['X_C_N_X_0'][1], i), cal(p['0_17'][2], p['X_C_N_X_0'][2], i), cal(p['0_17'][3], p['X_C_N_X_0'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(difoxy, difcar, 'n^', 'hm'), cal(p['0_18'][0], p['X_C_N_X_1000'][0], i), cal(p['0_18'][1], p['X_C_N_X_1000'][1], i), cal(p['0_18'][2], p['X_C_N_X_1000'][2], i), cal(p['0_18'][3], p['X_C_N_X_1000'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(difoxy, difcar, 'n^', 'hk'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonoxy, difcar, 'n^', 'CT'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonoxy, difcar, 'n^', 'hm'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonoxy, difcar, 'n^', 'hk'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CT', 'n^', difcar), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CT', difcar, 'n^'), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', 'CT', 'n^', difcar), cal(p['0_3'][0], p['C_N_CX_C_1'][0], i), cal(p['0_3'][1], p['C_N_CX_C_1'][1], i), cal(p['0_3'][2], p['C_N_CX_C_1'][2], i), cal(p['0_3'][3], p['C_N_CX_C_1'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', 'CT', 'n^', difcar), cal(p['0_8'][0], p['C_N_CX_C_2'][0], i), cal(p['0_8'][1], p['C_N_CX_C_2'][1], i), cal(p['0_8'][2], p['C_N_CX_C_2'][2], i), cal(p['0_8'][3], p['C_N_CX_C_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', 'CT', 'n^', difcar), cal(p['0_2'][0], p['C_N_CX_C_3'][0], i), cal(p['0_2'][1], p['C_N_CX_C_3'][1], i), cal(p['0_2'][2], p['C_N_CX_C_3'][2], i), cal(p['0_2'][3], p['C_N_CX_C_3'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', 'CT', 'n^', difcar), cal(p['0_7'][0], p['C_N_CX_C_4'][0], i), cal(p['0_7'][1], p['C_N_CX_C_4'][1], i), cal(p['0_7'][2], p['C_N_CX_C_4'][2], i), cal(p['0_7'][3], p['C_N_CX_C_4'][3], i))
                Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), difcar, cal(p['C'][2], p['C'][2], i), cal(p['C'][3], p['C'][3], i))
                Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), difoxy, cal(p['O2'][2], p['O2'][2], i), cal(p['O2'][3], p['O2'][3], i))
                Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), gonoxy, cal(p['O2'][2], p['0_O'][2], i), cal(p['O2'][3], p['0_O'][3], i))

def stock_add_to_all_FCX(dist, difcar='c^', gonoxy='ok', difoxy='om'):
        p = {}
        with open('Param_files/Stock/Stock.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
...
def stock_add_to_all_GCX(dist, difcar='c^', gonoxy='ok', difoxy='om'):
        p = {}
        with open('Param_files/Stock/Stock.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
        ...
        for i in range(11):
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CT', difcar, 'n^'), cal(p['0_14'][0], p['N_CX_C_N_3'][0], i), cal(p['0_14'][1], p['N_CX_C_N_3'][1], i), cal(p['0_14'][2], p['N_CX_C_N_3'][2], i), cal(p['0_14'][3], p['N_CX_C_N_3'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CT', difcar, 'n^'), cal(p['0_7'][0], p['N_CX_C_N_4'][0], i), cal(p['0_7'][1], p['N_CX_C_N_4'][1], i), cal(p['0_7'][2], p['N_CX_C_N_4'][2], i), cal(p['0_7'][3], p['N_CX_C_N_4'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', difcar, 'n^', 'CT'), cal(p['Ring_0'][0], p['X_C_N_X'][0], i), cal(p['Ring_0'][1], p['X_C_N_X'][1], i), cal(p['Ring_0'][2], p['X_C_N_X'][2], i), cal(p['Ring_0'][3], p['X_C_N_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', difcar, 'n^', 'hm'), cal(p['Ring_0'][0], p['X_C_N_X'][0], i), cal(p['Ring_0'][1], p['X_C_N_X'][1], i), cal(p['Ring_0'][2], p['X_C_N_X'][2], i), cal(p['Ring_0'][3], p['X_C_N_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', difcar, 'n^', 'hk'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(difoxy, difcar, 'n^', 'CT'), cal(p['Ring_0'][0], p['X_C_N_X'][0], i), cal(p['Ring_0'][1], p['X_C_N_X'][1], i), cal(p['Ring_0'][2], p['X_C_N_X'][2], i), cal(p['Ring_0'][3], p['X_C_N_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(difoxy, difcar, 'n^', 'hm'), cal(p['Ring_0'][0], p['X_C_N_X_1000'][0], i), cal(p['Ring_0'][1], p['X_C_N_X_1000'][1], i), cal(p['Ring_0'][2], p['X_C_N_X_1000'][2], i), cal(p['Ring_0'][3], p['X_C_N_X_1000'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(difoxy, difcar, 'n^', 'hk'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonoxy, difcar, 'n^', 'CT'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonoxy, difcar, 'n^', 'hm'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonoxy, difcar, 'n^', 'hk'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
...
def stock_add_to_all_GNX(dist, difnit='n^', gonhyd='hk', difhyd='hm'):
        p = {}
        with open('Param_files/Stock/Stock.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
        ...
        for i in range(11):
                a = i*10
                Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), difnit, cal(p['NA'][0], p['NA'][0], i), cal(p['NA'][1], p['NA'][1], i))
                Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), difhyd, cal(p['H'][0], p['H'][0], i), cal(p['H'][1], p['H'][1], i))
                Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), gonhyd, cal(p['H'][0], p['0_H'][0], i), cal(p['H'][1], p['0_H'][1], i))
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(difnit, difhyd), cal(p['NA_H'][0], p['NA_H'][0], i), cal(p['NA_H'][1], p['NA_H'][1], i))
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(difnit, gonhyd), cal(p['NA_H'][0], p['NA_H'][0], i), cal(p['NA_H'][1], p['NA_H'][1], i))
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(difnit, 'CT'), cal(p['C_N3'][0], p['CT_N'][0], i), cal(p['C_N3'][1], p['CT_N'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', difnit, difhyd), cal(p['C_C_H'][0], p['CT_N_H'][0], i), cal(p['C_C_H'][1], p['CT_N_H'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', difnit, gonhyd), cal(p['C_C_H'][0], p['CT_N_H'][0], i), cal(p['C_C_H'][1], p['CT_N_H'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(gonhyd, difnit, difhyd), cal(p['H_C_H'][0], p['Close'][0], i), cal(p['H_C_H'][1], p['Close'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(gonhyd, difnit, gonhyd), cal(p['H_C_H'][0], p['Close'][0], i), cal(p['H_C_H'][1], p['Close'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('H1', 'CT', difnit), cal(p['C_C_H'][0], p['C_C_H'][0], i), cal(p['C_C_H'][1], p['C_C_H'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('C ', 'CT', difnit), cal(p['N_CT_C'][0], p['N_CT_C'][0], i), cal(p['N_CT_C'][1], p['N_CT_C'][1], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', 'CT', difnit, difhyd), cal(p['X_C_C_X'][0], p['Ring_Dihe_2'][0], i), cal(p['X_C_C_X'][1], p['Ring_Dihe_2'][1], i), cal(p['X_C_C_X'][2], p['Ring_Dihe_2'][2], i), cal(p['X_C_C_X'][3], p['Ring_Dihe_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CT', difnit, difhyd), cal(p['X_C_C_X'][0], p['0_4'][0], i), cal(p['X_C_C_X'][1], p['0_4'][1], i), cal(p['X_C_C_X'][2], p['0_4'][2], i), cal(p['X_C_C_X'][3], p['0_4'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C ', 'CT', difnit, gonhyd), cal(p['X_C_C_X'][0], p['0_4'][0], i), cal(p['X_C_C_X'][1], p['0_4'][1], i), cal(p['X_C_C_X'][2], p['0_4'][2], i), cal(p['X_C_C_X'][3], p['0_4'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CT', difnit, gonhyd), cal(p['X_C_C_X'][0], p['0_4'][0], i), cal(p['X_C_C_X'][1], p['0_4'][1], i), cal(p['X_C_C_X'][2], p['0_4'][2], i), cal(p['X_C_C_X'][3], p['0_4'][3], i))
                Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), difnit, cal(p['NA'][2], p['NA'][2], i), cal(p['NA'][3], p['NA'][3], i))
                Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), difhyd, cal(p['H'][2], p['H'][2], i), cal(p['H'][3], p['H'][3], i))
                Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), gonhyd, cal(p['H'][2], p['0_H'][2], i), cal(p['H'][3], p['0_H'][3], i))
...
def stock_add_to_all_CYX(dist, newsul='ds', gonhyd='dh'):
        ...
        for i in range(11):
                ...
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(newsul, 'dc'), cal(p['0_0'][0], p['CT_S'][0], i), cal(p['0_0'][1], p['CT_S'][1], i))
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(newsul, 'dc', 'CT'), cal(p['X_CM_CM_0'][0], p['C_C_S'][0], i), cal(p['X_CM_CM_0'][1], p['C_C_S'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('dc', newsul, 'CT'), cal(p['X_CM_CM_0'][0], p['C_S_C'][0], i), cal(p['X_CM_CM_0'][1], p['C_S_C'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(newsul, 'dc', 'HC'), cal(p['X_CM_CM_0'][0], p['C_C_H'][0], i), cal(p['X_CM_CM_0'][1], p['C_C_H'][1], i))
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(gonhyd, newsul, 'dc'), cal(p['X_CM_CM_0'][0], p['X_CM_CM_0'][0], i), cal(p['X_CM_CM_0'][1], p['X_CM_CM_0'][1], i))
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(newsul, 'dc', 'dh'), cal(p['X_CM_CM_0'][0], p['X_CM_CM_0'][0], i), cal(p['X_CM_CM_0'][1], p['X_CM_CM_0'][1], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', newsul, 'ds', 'CT'), cal(p['0_8'][0], p['C_S_S_C_1'][0], i), cal(p['0_8'][1], p['C_S_S_C_1'][1], i), cal(p['0_8'][2], p['C_S_S_C_1'][2], i), cal(p['0_8'][3], p['C_S_S_C_1'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CT', newsul, 'dc'), cal(p['0_5'][0], p['X_C_SH_X'][0], i), cal(p['0_5'][1], p['X_C_SH_X'][1], i), cal(p['0_5'][2], p['X_C_SH_X'][2], i), cal(p['0_5'][3], p['X_C_SH_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', newsul, 'dc'), cal(p['0_5'][0], p['X_C_SH_X'][0], i), cal(p['0_5'][1], p['X_C_SH_X'][1], i), cal(p['0_5'][2], p['X_C_SH_X'][2], i), cal(p['0_5'][3], p['X_C_SH_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', newsul, 'dc', 'CT'), cal(p['0_5'][0], p['X_C_SH_X'][0], i), cal(p['0_5'][1], p['X_C_SH_X'][1], i), cal(p['0_5'][2], p['X_C_SH_X'][2], i), cal(p['0_5'][3], p['X_C_SH_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', newsul, 'dc', 'HC'), cal(p['0_5'][0], p['X_C_SH_X'][0], i), cal(p['0_5'][1], p['X_C_SH_X'][1], i), cal(p['0_5'][2], p['X_C_SH_X'][2], i), cal(p['0_5'][3], p['X_C_SH_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newsul, 'dc', 'CT', 'CT'), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newsul, 'dc', 'CT', 'HC'), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', newsul, 'dc', 'dh'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonhyd, newsul, 'dc', 'dh'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonhyd, newsul, 'dc', 'CT'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(gonhyd, newsul, 'dc', 'HC'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
...
def stock_add_to_all_HCX(dist, newsul='ds', gonhyd='dh'):
        p = {}
        with open('Param_files/Stock/Stock.param', 'r') as b:
                data = b.readlines()[1:]
        for line in data:
...
def stock_add_to_all_MCX(dist, newcar='dc', gonhyd='gh'):
        ...
        for i in range(11):
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', newcar, 'dc', 'S '), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', newcar, 'dc', 'S '), cal(p['0_4'][0], p['X_C_C_X'][0], i), cal(p['0_4'][1], p['X_C_C_X'][1], i), cal(p['0_4'][2], p['X_C_C_X'][2], i), cal(p['0_4'][3], p['X_C_C_X'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', newcar, 'dc', 'H1'), cal(p['0_4'][0], p['H_C_C_H'][0], i), cal(p['0_4'][1], p['H_C_C_H'][1], i), cal(p['0_4'][2], p['H_C_C_H'][2], i), cal(p['0_4'][3], p['H_C_C_H'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', newcar, 'dc', 'H1'), cal(p['0_4'][0], p['C_C_C_H'][0], i), cal(p['0_4'][1], p['C_C_C_H'][1], i), cal(p['0_4'][2], p['C_C_C_H'][2], i), cal(p['0_4'][3], p['C_C_C_H'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', newcar, 'dc', 'dh'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', newcar, 'dc', 'gh'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('dh', newcar, 'dc', 'gh'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('S ', newcar, 'dc', 'dh'), cal(p['0_Dihe'][0], p['0_Dihe'][0], i), cal(p['0_Dihe'][1], p['0_Dihe'][1], i), cal(p['0_Dihe'][2], p['0_Dihe'][2], i), cal(p['0_Dihe'][3], p['0_Dihe'][3], i))
