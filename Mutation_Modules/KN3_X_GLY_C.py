...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@O'.format(vxi), ':{}@H1'.format(vxi), '0', '0').execute()
                ...
                change(parm, 'charge', ':{}@HG2'.format(vxi), bc['HG2']).execute()
                change(parm, 'charge', ':{}@HG3'.format(vxi), bc['HG3']).execute()
                change(parm, 'charge', ':{}@CD'.format(vxi), bc['CD']).execute()
                change(parm, 'charge', ':{}@HD2'.format(vxi), bc['HD2']).execute()
                change(parm, 'charge', ':{}@HD3'.format(vxi), bc['HD3']).execute()
                change(parm, 'charge', ':{}@CE'.format(vxi), bc['CE']).execute()
                change(parm, 'charge', ':{}@HE2'.format(vxi), bc['HE2']).execute()
                change(parm, 'charge', ':{}@HE3'.format(vxi), bc['HE3']).execute()
                change(parm, 'charge', ':{}@NZ'.format(vxi), bc['NZ']).execute()
                change(parm, 'charge', ':{}@NH'.format(vxi), bc['NH']).execute()
                change(parm, 'charge', ':{}@NT'.format(vxi), bc['NT']).execute()
...
def lib_make(ff, outputfile, vxi='VXI', var=variablemake()):
	...
	newoxy = var[8]
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
	ctrl.write("%s=loadpdb Param_files/LibPDB/KN3_X_GLY.pdb\n"%vxi)
	...
	ctrl.write('set %s.1.19 element "N"\n'%vxi)
	...
	ctrl.write('set %s.1.18 name "NH"\n'%vxi)
	ctrl.write('set %s.1.19 name "NT"\n'%vxi)
	ctrl.write('set %s.1.20 name "C"\n'%vxi)
	ctrl.write('set %s.1.21 name "O"\n'%vxi)
	ctrl.write('set %s.1.22 name "N1"\n'%vxi)
	ctrl.write('set %s.1.23 name "H1"\n'%vxi)
	ctrl.write('set %s.1.24 name "CA1"\n'%vxi)
	ctrl.write('set %s.1.25 name "HA12"\n'%vxi)
	ctrl.write('set %s.1.26 name "HA13"\n'%vxi)
	ctrl.write('set %s.1.27 name "C1"\n'%vxi)
	ctrl.write('set %s.1.28 name "O1"\n'%vxi)
	ctrl.write('set %s.1.1  type "N"\n'%vxi)
	ctrl.write('set %s.1.2  type "H"\n'%vxi)
	ctrl.write('set %s.1.3  type "CX"\n'%vxi)
	ctrl.write('set %s.1.4  type "H1"\n'%vxi)
	ctrl.write('set %s.1.5  type "C8"\n'%vxi)
	ctrl.write('set %s.1.6  type "HC"\n'%vxi)
	ctrl.write('set %s.1.7  type "HC"\n'%vxi)
	ctrl.write('set %s.1.8  type "C8"\n'%vxi)
	ctrl.write('set %s.1.9  type "HC"\n'%vxi)
	ctrl.write('set %s.1.10 type "HC"\n'%vxi)
	ctrl.write('set %s.1.11 type "C8"\n'%vxi)
	ctrl.write('set %s.1.12 type "HC"\n'%vxi)
	ctrl.write('set %s.1.13 type "HC"\n'%vxi)
	ctrl.write('set %s.1.14 type "C8"\n'%vxi)
	ctrl.write('set %s.1.15 type "HP"\n'%vxi)
	ctrl.write('set %s.1.16 type "HP"\n'%vxi)
	ctrl.write('set %s.1.17 type "NI"\n'%vxi)
	ctrl.write('set %s.1.18 type "ND"\n'%vxi)
	ctrl.write('set %s.1.19 type "NE"\n'%vxi)
...
def stock_add_to_all(var=variablemake()):
	...
	newoxy = var[8]
        ...
        for i in range(11):
                ...
                Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CX', oldcar), cal(p['Third'][0], p['CT_C'][0], i), cal(p['Third'][1], p['CT_C'][1], i))
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('H1', 'CX', oldcar), cal(p['C_C_H'][0], p['C_C_H'][0], i), cal(p['C_C_H'][1], p['C_C_H'][1], i))
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('C8', 'CX', oldcar), cal(p['CT_CT_C'][0], p['CT_CT_C'][0], i), cal(p['CT_CT_C'][1], p['CT_CT_C'][1], i))
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('N ', 'CX', oldcar), cal(p['CT_CT_C'][0], p['CT_CT_C'][0], i), cal(p['CT_CT_C'][1], p['CT_CT_C'][1], i))
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CX', oldcar, oldoxy), cal(p['Dritt'][0], p['C_C_O'][0], i), cal(p['Dritt'][1], p['C_C_O'][1], i))
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CX', oldcar, newnit), cal(p['Dritt'][0], p['C_C_N'][0], i), cal(p['Dritt'][1], p['C_C_N'][1], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CX', oldcar, oldoxy), cal(p['0_10'][0], p['H_C_C_O_1'][0], i), cal(p['0_10'][1], p['H_C_C_O_1'][1], i), cal(p['0_10'][2], p['H_C_C_O_1'][2], i), cal(p['0_10'][3], p['H_C_C_O_1'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CX', oldcar, oldoxy), cal(p['0_8'][0], p['H_C_C_O_2'][0], i), cal(p['0_8'][1], p['H_C_C_O_2'][1], i), cal(p['0_8'][2], p['H_C_C_O_2'][2], i), cal(p['0_8'][3], p['H_C_C_O_2'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CX', oldcar, oldoxy), cal(p['0_9'][0], p['H_C_C_O_3'][0], i), cal(p['0_9'][1], p['H_C_C_O_3'][1], i), cal(p['0_9'][2], p['H_C_C_O_3'][2], i), cal(p['0_9'][3], p['H_C_C_O_3'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newnit, oldcar, 'CX', 'C8'), lac(p['C_C_C_N_1'][0], p['0_3'][0], i), lac(p['C_C_C_N_1'][1], p['0_3'][1], i), lac(p['C_C_C_N_1'][2], p['0_3'][2], i), lac(p['C_C_C_N_1'][3], p['0_3'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newnit, oldcar, 'CX', 'C8'), lac(p['C_C_C_N_2'][0], p['0_8'][0], i), lac(p['C_C_C_N_2'][1], p['0_8'][1], i), lac(p['C_C_C_N_2'][2], p['0_8'][2], i), lac(p['C_C_C_N_2'][3], p['0_8'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newnit, oldcar, 'CX', 'C8'), lac(p['C_C_C_N_3'][0], p['0_2'][0], i), lac(p['C_C_C_N_3'][1], p['0_2'][1], i), lac(p['C_C_C_N_3'][2], p['0_2'][2], i), lac(p['C_C_C_N_3'][3], p['0_2'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(newnit, oldcar, 'CX', 'C8'), lac(p['C_C_C_N_4'][0], p['0_7'][0], i), lac(p['C_C_C_N_4'][1], p['0_7'][1], i), lac(p['C_C_C_N_4'][2], p['0_7'][2], i), lac(p['C_C_C_N_4'][3], p['0_7'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('H1', 'CX', oldcar, newnit), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CX', oldcar, newnit), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('C8', 'CX', oldcar, oldoxy), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('N ', 'CX', oldcar, oldoxy), cal(p['Ring_Dihe_2'][0], p['Ring_Dihe_2'][0], i), cal(p['Ring_Dihe_2'][1], p['Ring_Dihe_2'][1], i), cal(p['Ring_Dihe_2'][2], p['Ring_Dihe_2'][2], i), cal(p['Ring_Dihe_2'][3], p['Ring_Dihe_2'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CX', oldcar, newnit, newhyd), cal(p['Ring_0'][0], p['X_C_N_X'][0], i), cal(p['Ring_0'][1], p['X_C_N_X'][1], i), cal(p['Ring_0'][2], p['X_C_N_X'][2], i), cal(p['Ring_0'][3], p['X_C_N_X'][3], i))
		...
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CX', oldcar, newnit, newalp), cal(p['Ring_0'][0], p['X_C_N_X'][0], i), cal(p['Ring_0'][1], p['X_C_N_X'][1], i), cal(p['Ring_0'][2], p['X_C_N_X'][2], i), cal(p['Ring_0'][3], p['X_C_N_X'][3], i))
