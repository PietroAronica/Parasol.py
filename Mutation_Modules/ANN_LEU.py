...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@HG :{}@HD12 0 0'.format(vxi, vxi)).execute()
		changeLJPair(parm, ':{}@HD21 :{}@HD13 0 0'.format(vxi, vxi)).execute()
		changeLJPair(parm, ':{}@HD21 :{}@CD1 0 0'.format(vxi, vxi)).execute()
		changeLJPair(parm, ':{}@HD21 :{}@CD4 0 0'.format(vxi, vxi)).execute()
