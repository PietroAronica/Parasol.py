...
def lib_make(ff, outputfile, vxi='VXI', estsul='ss', mthhyd='th', metcar='cd', methyd='dh', hydhyd='mh'):
        ctrl = open('lyp.in', 'w')
        ctrl.write("source %s\n"%ff)
...
def stock_add_to_all(estsul='ss', mthhyd='th', metcar='cd', methyd='dh', hydhyd='mh'):
