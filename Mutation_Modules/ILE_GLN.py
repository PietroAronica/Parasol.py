	...
	pdb = open(out, 'w')
        ...
        for res in struct.residue_list:
			...
			if atom.get_name() == 'HB' and res.get_resname() == vxi:
                        	...
                        	pdb.write(atom.halfway_between('CD', CG1, HG12))
                                pdb.write(atom.superimposed1('OE1', HG12))
                                pdb.write(atom.superimposed2('NE2', HG12))
                                pdb.write(atom.halfway_after1('HE21', CG1, HG12))
                                pdb.write(atom.halfway_after2('HE22', CG1, HG12))
			else:
                        	pdb.write(atom.formatted())
                try:
...
def stock_add_to_all(vxi='VXI', metcar1='1c', methyd1='1h', hydhyd1='xh', metcar2='2c', methyd2='2h', hydhyd2='yh', amicar='ac', amioxy='ao', aminit='an', amihyd='ah', hydhyd3='sh'):
	...
	for i in range(11):
		a = i*10
                ...
                Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(amicar, 'CT', metcar2), lac(p['C_C_H'][0], p['C_C_H'][0], i), lac(p['C_C_H'][1], p['C_C_H'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(amicar, 'CT', metcar2, methyd2), lac(p['0_Dihe'][0], p['0_Dihe'][0], i), lac(p['0_Dihe'][1], p['0_Dihe'][1], i), lac(p['0_Dihe'][2], p['0_Dihe'][2], i), lac(p['0_Dihe'][3], p['0_Dihe'][3], i))
