...
def parmed_command(vxi='VXI', lipid='No'):
	...
	for i in range(11):
		...
		changeLJPair(parm, ':{}@HG2'.format(vxi), ':{}@HD12'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HG3'.format(vxi), ':{}@HD13'.format(vxi), '0', '0').execute()
		changeLJPair(parm, ':{}@HE'.format(vxi), ':{}@HE1'.format(vxi), '0', '0').execute()
