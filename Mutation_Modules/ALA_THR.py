...
def stock_add_to_all(metcar='cd', methyd='dh', hydhyd1='mh', alcoxy='oh', alchyd='hh', hydhyd2='sh', thrhyd='hf'):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(thrhyd, 'CT', hydhyd1), lac(p['H_C_H'][0], p['H_C_H'][0], i), lac(p['H_C_H'][1], p['H_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(thrhyd, 'CT', metcar), lac(p['C_C_H'][0], p['C_C_H'][0], i), lac(p['C_C_H'][1], p['C_C_H'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(thrhyd, 'CT', metcar, methyd), lac(p['X_C_C_X'][0], p['0_1'][0], i), lac(p['X_C_C_X'][1], p['0_1'][1], i), lac(p['X_C_C_X'][2], p['0_1'][2], i), lac(p['X_C_C_X'][3], p['0_1'][3], i))
