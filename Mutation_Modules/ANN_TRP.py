...
def stock_add_to_all(var=variablemake()):
	...
	for i in range(11):
		...
		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), ne1, lac(p['NA'][0], p['0_N'][0], i), lac(p['NA'][1], p['0_N'][1], i))
		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), he1, lac(p['H'][0], p['0_H'][0], i), lac(p['H'][1], p['0_H'][1], i))
		...
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(cd1, ne1), lac(p['CW_NA'][0], p['NA_mCA'][0], i), lac(p['CW_NA'][1], p['NA_mCA'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(ne1, ce2), lac(p['CN_NA'][0], p['NA_mCA'][0], i), lac(p['CN_NA'][1], p['NA_mCA'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(ne1, he1), lac(p['NA_H'][0], p['H_mCA'][0], i), lac(p['NA_H'][1], p['H_mCA'][1], i))
		...
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(ce3, cz2), lac(p['CA_CA'][0], p['CA_tCA'][0], i), lac(p['CA_CA'][1], p['CA_tCA'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(cz2, ch), lac(p['CA_CA'][0], p['CA_tCA'][0], i), lac(p['CA_CA'][1], p['CA_tCA'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(cz1, ch), lac(p['CA_CA'][0], p['CA_tCA'][0], i), lac(p['CA_CA'][1], p['CA_tCA'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(cz2, hz2), lac(p['CA_HA'][0], p['HA_tCA'][0], i), lac(p['CA_HA'][1], p['HA_tCA'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format(ch, hh), lac(p['CA_HA'][0], p['HA_tCA'][0], i), lac(p['CA_HA'][1], p['HA_tCA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', cg), lac(p['C_C_C*'][0], p['C_C_C*'][0], i), lac(p['C_C_C*'][1], p['C_C_C*'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('HC', 'CT', cg), lac(p['C_C_H'][0], p['C_C_H'][0], i), lac(p['C_C_H'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', cg, cd1), lac(p['CT_C*_CW'][0], p['A_CT_CA_CA'][0], i), lac(p['CT_C*_CW'][1], p['A_CT_CA_CA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', cg, cd2), lac(p['CT_C*_CB'][0], p['A_CT_CA_CA'][0], i), lac(p['CT_C*_CB'][1], p['A_CT_CA_CA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cd1, cg, cd2), lac(p['CW_C*_CB'][0], p['A_CA_CA_CA'][0], i), lac(p['CW_C*_CB'][1], p['A_CA_CA_CA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cg, cd1, ne1), lac(p['C*_CW_NA'][0], p['A_CA_CA_CA'][0], i), lac(p['C*_CW_NA'][1], p['A_CA_CA_CA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cg, cd1, hd1), lac(p['F_CA_CA_HA'][0], p['A_CA_CA_HA'][0], i), lac(p['F_CA_CA_HA'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cd1, ne1, ce2), lac(p['CW_NA_CN'][0], p['Dritt'][0], i), lac(p['CW_NA_CN'][1], p['Dritt'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(he1, ne1, ce2), lac(p['CW_NA_H'][0], p['Dritt'][0], i), lac(p['CW_NA_H'][1], p['Dritt'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(ne1, cd1, hd1), lac(p['F_CA_CA_HA'][0], p['A_CA_CA_HA'][0], i), lac(p['F_CA_CA_HA'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(he1, ne1, cd1), lac(p['F_CA_CA_HA'][0], p['Close'][0], i), lac(p['F_CA_CA_HA'][1], p['Close'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cg, cd2, ce3), lac(p['C*_CB_CA'][0], p['A_CA_CA_HA'][0], i), lac(p['C*_CB_CA'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cg, cd2, ce2), lac(p['C*_CB_CN'][0], p['A_CA_CA_CA'][0], i), lac(p['C*_CB_CN'][1], p['A_CA_CA_CA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cd2, ce2, ne1), lac(p['CB_CN_NA'][0], p['A_CA_CA_CA'][0], i), lac(p['CB_CN_NA'][1], p['A_CA_CA_CA'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(ce2, cd2, ce3), lac(p['CA_CB_CN'][0], p['A_CA_CA_HA'][0], i), lac(p['CA_CB_CN'][1], p['A_CA_CA_HA'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cd2, ce2, cz1), lac(p['CA_CN_CB'][0], p['A_CA_CA_HA'][0], i), lac(p['CA_CN_CB'][1], p['A_CA_CA_HA'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(cz1, ce2, ne1), lac(p['CA_CN_NA'][0], p['A_CA_CA_HA'][0], i), lac(p['CA_CN_NA'][1], p['A_CA_CA_HA'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hz2, cz2, ch), lac(p['F_CA_CA_HA'][0], p['Dritt'][0], i), lac(p['F_CA_CA_HA'][1], p['Dritt'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', cg, cd1, ne1), lac(p['X_C_CW_X'][0], p['Ring_0'][0], i), lac(p['X_C_CW_X'][1], p['Ring_0'][1], i), lac(p['X_C_CW_X'][2], p['Ring_Dihe'][2], i), lac(p['X_C_CW_X'][3], p['Ring_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cd2, cg, cd1, ne1), lac(p['X_C_CW_X'][0], p['Ring_0'][0], i), lac(p['X_C_CW_X'][1], p['Ring_0'][1], i), lac(p['X_C_CW_X'][2], p['Ring_Dihe'][2], i), lac(p['X_C_CW_X'][3], p['Ring_Dihe'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd1, ne1, he1), lac(p['X_CW_NA_X'][0], p['Ring_0'][0], i), lac(p['X_CW_NA_X'][1], p['Ring_0'][1], i), lac(p['X_CW_NA_X'][2], p['Ring_0'][2], i), lac(p['X_CW_NA_X'][3], p['Ring_0'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd1, ne1, ce2), lac(p['X_CW_NA_X'][0], p['Ring_0'][0], i), lac(p['X_CW_NA_X'][1], p['Ring_0'][1], i), lac(p['X_CW_NA_X'][2], p['Ring_0'][2], i), lac(p['X_CW_NA_X'][3], p['Ring_0'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cz1, ce2, ne1, he1), lac(p['X_CN_NA_X'][0], p['Ring_0'][0], i), lac(p['X_CN_NA_X'][1], p['Ring_0'][1], i), lac(p['X_CN_NA_X'][2], p['Ring_0'][2], i), lac(p['X_CN_NA_X'][3], p['Ring_0'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cz1, ce2, ne1, cd1), lac(p['X_CN_NA_X'][0], p['Ring_0'][0], i), lac(p['X_CN_NA_X'][1], p['Ring_0'][1], i), lac(p['X_CN_NA_X'][2], p['Ring_0'][2], i), lac(p['X_CN_NA_X'][3], p['Ring_0'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cd2, ce2, ne1, he1), lac(p['X_CN_NA_X'][0], p['Ring_0'][0], i), lac(p['X_CN_NA_X'][1], p['Ring_0'][1], i), lac(p['X_CN_NA_X'][2], p['Ring_0'][2], i), lac(p['X_CN_NA_X'][3], p['Ring_0'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cd2, ce2, ne1, cd1), lac(p['X_CN_NA_X'][0], p['Ring_0'][0], i), lac(p['X_CN_NA_X'][1], p['Ring_0'][1], i), lac(p['X_CN_NA_X'][2], p['Ring_0'][2], i), lac(p['X_CN_NA_X'][3], p['Ring_0'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(cg, cd2, ce2, ne1), lac(p['X_CN_CB_X'][0], p['Ring_0'][0], i), lac(p['X_CN_CB_X'][1], p['Ring_0'][1], i), lac(p['X_CN_CB_X'][2], p['Ring_0'][2], i), lac(p['X_CN_CB_X'][3], p['Ring_0'][3], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(ce3, cd2, ce2, ne1), lac(p['X_CN_CB_X'][0], p['Ring_0'][0], i), lac(p['X_CN_CB_X'][1], p['Ring_0'][1], i), lac(p['X_CN_CB_X'][2], p['Ring_0'][2], i), lac(p['X_CN_CB_X'][3], p['Ring_0'][3], i))
		...
		Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), ne1, lac(p['NA'][2], p['0_N'][2], i), lac(p['NA'][3], p['0_N'][3], i))
		Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), he1, lac(p['H'][2], p['0_H'][2], i), lac(p['H'][3], p['0_H'][3], i))
