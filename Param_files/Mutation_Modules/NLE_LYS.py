...
def stock_add_to_all(aminit='dn', amihyd='dh', hydhyd='mh', lyshyd='fh'):
	...
	for i in range(11):
		...
		Frcmod_creator.MASS_insert('{}_{}.frcmod'.format(a, 100-a), lyshyd, cal2(p['HP'][0], p['HC'][0], i), cal2(p['HP'][1], p['HC'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CT', aminit), cal2(p['C_N3'][0], p['CT_mH'][0], i), cal2(p['C_N3'][1], p['CT_mH'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CT', hydhyd), cal2(p['HC_sN3'][0], p['CT_HC'][0], i), cal2(p['HC_sN3'][1], p['CT_HC'][1], i))
		Frcmod_creator.BOND_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}'.format('CT', lyshyd), cal2(p['CT_HC'][0], p['CT_HC'][0], i), cal2(p['CT_HC'][1], p['CT_HC'][1], i))
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', aminit, amihyd), cal2(p['C_C_H'][0], p['Dritt'][0], i), cal2(p['C_C_H'][1], p['Dritt'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(amihyd, aminit, amihyd), cal2(p['H_C_H'][0], p['Close'][0], i), cal2(p['H_C_H'][1], p['Close'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', aminit), cal2(p['C_C_H'][0], p['C_C_N'][0], i), cal2(p['C_C_H'][1], p['C_C_N'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(lyshyd, 'CT', aminit), cal2(p['C_C_H'][0], p['C_C_H'][0], i), cal2(p['C_C_H'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(lyshyd, 'CT', lyshyd), cal2(p['H_C_H'][0], p['H_C_H'][0], i), cal2(p['H_C_H'][1], p['H_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(lyshyd, 'CT', hydhyd), cal2(p['H_C_H'][0], p['H_C_H'][0], i), cal2(p['H_C_H'][1], p['H_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format(hydhyd, 'CT', aminit), cal2(p['Close'][0], p['Close'][0], i), cal2(p['Close'][1], p['Close'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', lyshyd), cal2(p['C_C_H'][0], p['C_C_H'][0], i), cal2(p['C_C_H'][1], p['C_C_H'][1], i))
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', hydhyd), cal2(p['C_C_NH'][0], p['C_C_H'][0], i), cal2(p['C_C_NH'][1], p['C_C_H'][1], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', aminit, amihyd), cal2(p['X_C_C_X'][0], p['0_4'][0], i), cal2(p['X_C_C_X'][1], p['0_4'][1], i), cal2(p['X_C_C_X'][2], p['0_4'][2], i), cal2(p['X_C_C_X'][3], p['0_4'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(lyshyd, 'CT', aminit, amihyd), cal2(p['X_C_C_X'][0], p['0_4'][0], i), cal2(p['X_C_C_X'][1], p['0_4'][1], i), cal2(p['X_C_C_X'][2], p['0_4'][2], i), cal2(p['X_C_C_X'][3], p['0_4'][3], i))
		Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format(hydhyd, 'CT', aminit, amihyd), cal2(p['0_Dihe'][0], p['0_Dihe'][0], i), cal2(p['0_Dihe'][1], p['0_Dihe'][1], i), cal2(p['0_Dihe'][2], p['0_Dihe'][2], i), cal2(p['0_Dihe'][3], p['0_Dihe'][3], i))
		...
		Frcmod_creator.NONBON_insert('{}_{}.frcmod'.format(a, 100-a), lyshyd, cal2(p['HP'][2], p['HC'][2], i), cal2(p['HP'][3], p['HC'][3], i))
