...
def stock_add_to_all(cg='1c', hg1='0h', hg2='1h', cd1='2c', hd11='2h', cd2='3c', hd21='3h', cd='4c', hd1='4h', hd2='5h', hd3='6h'):
	...
	for i in range(11):
		...
		Frcmod_creator.ANGLE_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}'.format('CT', 'CT', cg), cal(p['C_C_CA'][0], p['C_C_H'][0], i), cal(p['C_C_CA'][1], p['C_C_H'][1], i))
                ...
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', cg, hg1), cal(p['0_Dihe'][0], p['H_C_C_H'][0], i), cal(p['0_Dihe'][1], p['H_C_C_H'][1], i), cal(p['0_Dihe'][2], p['H_C_C_H'][2], i), cal(p['0_Dihe'][3], p['H_C_C_H'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', cg, hg2), cal(p['0_Dihe'][0], p['H_C_C_H'][0], i), cal(p['0_Dihe'][1], p['H_C_C_H'][1], i), cal(p['0_Dihe'][2], p['H_C_C_H'][2], i), cal(p['0_Dihe'][3], p['H_C_C_H'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', cg, hg1), cal(p['0_Dihe'][0], p['C_C_C_H'][0], i), cal(p['0_Dihe'][1], p['C_C_C_H'][1], i), cal(p['0_Dihe'][2], p['C_C_C_H'][2], i), cal(p['0_Dihe'][3], p['C_C_C_H'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('CT', 'CT', cg, hg2), cal(p['0_Dihe'][0], p['C_C_C_H'][0], i), cal(p['0_Dihe'][1], p['C_C_C_H'][1], i), cal(p['0_Dihe'][2], p['C_C_C_H'][2], i), cal(p['0_Dihe'][3], p['C_C_C_H'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', cg, cd1), cal(p['0_Dihe'][0], p['C_C_C_H'][0], i), cal(p['0_Dihe'][1], p['C_C_C_H'][1], i), cal(p['0_Dihe'][2], p['C_C_C_H'][2], i), cal(p['0_Dihe'][3], p['C_C_C_H'][3], i))
                Frcmod_creator.DIHEDRAL_insert('{}_{}.frcmod'.format(a, 100-a), '{}-{}-{}-{}'.format('HC', 'CT', cg, cd2), cal(p['0_Dihe'][0], p['C_C_C_H'][0], i), cal(p['0_Dihe'][1], p['C_C_C_H'][1], i), cal(p['0_Dihe'][2], p['C_C_C_H'][2], i), cal(p['0_Dihe'][3], p['C_C_C_H'][3], i))
