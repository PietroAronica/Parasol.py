	...
	pdb = open(out, 'w')
        ...
        for res in struct.residue_list:
			...
			if atom.get_name() == 'HG3' and res.get_resname() == vxi:
                        	...
                        	pdb.write(atom.superimposed1('OE1', HG1))
                        	pdb.write(atom.superimposed2('NE2', HG1))
                        	pdb.write(atom.halfway_after1('HE21', CG, HG1))
                        	pdb.write(atom.halfway_after2('HE22', CG, HG1))
			else:
                        	pdb.write(atom.formatted())
                try:
...
def lib_make(ff, outputfile, vxi='VXI', amicar='ac', amioxy='ao', aminit='an', amihyd='ah', hydhyd='sh'):
	...
	ctrl.write("%s=loadpdb Param_files/LibPDB/GLN-ABU.pdb\n"%vxi)
